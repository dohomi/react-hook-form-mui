import {c as Do, a as zo} from './index.3861d36b.js'
import {a as cn, f as Mo, j as Oa} from './iframe.b13c84ce.js'
function za($a) {
  return (
    (za =
 ...
 */ ;(function ($a) {
  ...
  })(typeof window != 'undefined' ? window : Do, function (ar, Lr, z) {
...
` + ar.JSON.stringify(q, null, 2)
        ...
        function sr(w, M, vr, R, Er) {
          ...
          function ho() {
            ...
            function nr(U) {
              ti !== !0 &&
                ((U = U.originalEvent || U), fo(U.propertyName) && L.update(zr))
            }
            function pr(U) {
              gr ||
                (o !== z
...
//# sourceMappingURL=OverlayScrollbars-26c4a78d.a724cc42.js.map
