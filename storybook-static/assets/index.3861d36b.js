...
function _iterableToArrayLimit$5(ee, _) {
  var te =
    ee == null
      ? null
      : (typeof Symbol != 'undefined' && ee[Symbol.iterator]) ||
        ee['@@iterator']
  if (te != null) {
    var re = [],
      ae = !0,
...
function parse$3(ee, _, te, re, ae, ne, oe, ie, le) {
  for (
    ...
    switch (((se = ve), (ve = next()))) {
      case 40:
        if (se != 108 && _e.charCodeAt(pe - 1) == 58) {
        ...
        switch (ve) {
          ...
          case 59 + ue:
            me > 0 &&
              ...
              append(
                me > 32
                  ? declaration(_e + ';', re, te, pe - 1)
                  : declaration(replace(_e, ' ', '') + ';', re, te, pe - 2),
                le
              )
            break
          case 59:
          ...
          default:
            if (
              ...
              if (ue === 0) parse$3(_e, _, $e, $e, be, ne, pe, ie, xe)
              else
                switch (de) {
                  case 100:
                  case 109:
                  case 115:
                    ...
                    break
                  default:
                    parse$3(_e, $e, $e, $e, [''], xe, 0, ie, xe)
                }
        }
        ;(ce = ue = me = 0), (he = ge = 1), (ye = _e = ''), (pe = oe)
        break
      case 58:
        ;(pe = 1 + strlen(_e)), (me = se)
      default:
        if (he < 1) {
          if (ve == 123) --he
        ...
        switch (((_e += from(ve)), ve * he)) {
          ...
          case 64:
            peek() === 45 && (_e += delimit(next())),
              (de = peek()),
              (ue = pe = strlen((ye = _e += identifier(caret())))),
              ve++
            break
          case 45:
            se === 45 && strlen(_e) == 2 && (he = 0)
        }
    }
  return ne
}
function ruleset(ee, _, te, re, ae, ne, oe, ie, le, ce, ue) {
  for (
    var pe = ae - 1,
      de = ae === 0 ? ne : [''],
      me = sizeof(de),
    ...
    for (
      var ge = 0, ve = substr(ee, pe + 1, (pe = abs((he = oe[se])))), ye = ee;
      ge < me;
      ++ge
    )
      (ye = trim(he > 0 ? de[ge] + ' ' + ve : replace(ve, /&\f/g, de[ge]))) &&
        (le[fe++] = ye)
  return node(ee, _, te, ae === 0 ? RULESET : ie, le, ce, ue)
}
...
var weakMemoize = function (_) {
    ...
    if (!(_.type !== 'rule' || !_.parent || _.length < 1)) {
      ...
      if (
        ...
        for (
          ...
          for (var ue = 0; ue < ie.length; ue++, ce++)
            _.props[ce] = ne[le]
              ? oe[le].replace(/&\f/g, ie[ue])
              : ie[ue] + ' ' + oe[le]
      }
    }
  },
  ...
  isBrowser$6 = typeof document != 'undefined',
  ...
  createCache = function (_) {
    ...
    if (isBrowser$6 && te === 'css') {
      ...
      Array.prototype.forEach.call(re, function (be) {
        var xe = be.getAttribute('data-emotion')
        xe.indexOf(' ') !== -1 &&
    ...
    isBrowser$6 &&
      ...
      Array.prototype.forEach.call(
        ...
        function (be) {
          for (
            var xe = be.getAttribute('data-emotion').split(' '), $e = 1;
            $e < xe.length;
            $e++
          )
            ne[xe[$e]] = !0
    ...
    if (isBrowser$6) {
      var ue,
        ...
        de = middleware(ce.concat(ae, pe)),
        me = function (xe) {
          return serialize(compile(xe), de)
        }
      le = function (xe, $e, _e, Se) {
        ;(ue = _e),
          me(xe ? xe + '{' + $e.styles + '}' : $e.styles),
          Se && (ye.inserted[$e.name] = !0)
      }
    } else {
      var se = [stringify],
        he = middleware(ce.concat(ae, se)),
        fe = function (xe) {
          return serialize(compile(xe), he)
        },
        ...
        ve = function (xe, $e) {
          ...
          return (
            ge[_e] === void 0 &&
              (ge[_e] = fe(xe ? xe + '{' + $e.styles + '}' : $e.styles)),
            ge[_e]
          )
        }
      le = function (xe, $e, _e, Se) {
        var Ee = $e.name,
          Te = ve(xe, $e)
        if (ye.compat === void 0) return Se && (ye.inserted[Ee] = !0), Te
        if (Se) ye.inserted[Ee] = Te
        else return Te
      }
    }
    var ye = {
...
var labelPattern$1 = /label:\s*([^\s;\n{]+)\s*(;|$)/g,
  ...
  serializeStyles$1 = function (_, te, re) {
    ...
    for (var le = '', ce; (ce = labelPattern$1.exec(ne)) !== null; )
      le += '-' + ce[1]
    var ue = murmur2(ne) + le
    return {name: ue, styles: ne, next: cursor$1}
  },
  isBrowser$4 = typeof document != 'undefined',
        ...
        function () {
          var pe = _.key + '-global',
            ...
            se = document.querySelector(
              'style[data-emotion="' + pe + ' ' + re.name + '"]'
            )
          return (
            _.sheet.tags.length && (de.before = _.sheet.tags[0]),
            se !== null &&
              ((me = !0),
              se.setAttribute('data-emotion', pe),
              de.hydrate([se])),
            (ue.current = [de, me]),
            function () {
              de.flush()
      ...
      useInsertionEffect$1(
        function () {
          ...
          if (
            ...
            var se = de.tags[de.tags.length - 1].nextElementSibling
            ;(de.before = se), de.flush()
          }
          _.insert('', re, de, !1)
        },
        [_, re.name]
...
var keyframes = function () {
  ...
  isBrowser$2 = typeof document != 'undefined'
      ...
      if (_typeof$1(oe) !== 'object')
        _ != null && _[oe] !== void 0
          ...
          : isProcessableValue(oe) &&
            (re += processStyleName(ne) + ':' + processStyleValue(ne, oe) + ';')
      else if (
        Array.isArray(oe) &&
        typeof oe[0] == 'string' &&
        (_ == null || _[oe[0]] === void 0)
...
var labelPattern = /label:\s*([^\s;\n{]+)\s*(;|$)/g,
  ...
  serializeStyles = function (_, te, re) {
    ...
    for (var le = '', ce; (ce = labelPattern.exec(ne)) !== null; )
      le += '-' + ce[1]
    var ue = murmur2(ne) + le
    return {name: ue, styles: ne, next: cursor}
  },
...
var isBrowser$1 = typeof document != 'undefined',
  ...
  createStyled = function ee(_, te) {
    ...
    return function () {
      var ue = arguments,
        pe =
          re && _.__emotion_styles !== void 0 ? _.__emotion_styles.slice(0) : []
      if (
        (ne !== void 0 && pe.push('label:' + ne + ';'),
        ue[0] == null || ue[0].raw === void 0)
      )
        pe.push.apply(pe, ue)
      else {
        pe.push(ue[0][0])
        for (var de = ue.length, me = 1; me < de; me++)
          pe.push(ue[me], ue[0][me])
      }
      var se = withEmotionCache(function (he, fe, ge) {
        var ve = (ce && he.as) || ae,
          ye = '',
          be = [],
          xe = he
        ...
        var _e = serializeStyles(pe.concat(be), fe.registered, xe)
        ;(ye += fe.key + '-' + _e.name), oe !== void 0 && (ye += ' ' + oe)
        var Se = ce && ie === void 0 ? getDefaultShouldForwardProp(ve) : le,
          Ee = {}
        for (var Te in he) (ce && Te === 'as') || (Se(Te) && (Ee[Te] = he[Te]))
        return (
          (Ee.className = ye),
          (Ee.ref = ge),
          react.exports.createElement(
        ...
        (se.displayName =
          ne !== void 0
            ...
            : 'Styled(' +
              ...
              ')'),
        (se.defaultProps = _.defaultProps),
        (se.__emotion_real = se),
        (se.__emotion_base = ae),
        (se.__emotion_styles = pe),
        (se.__emotion_forwardProp = ie),
        Object.defineProperty(se, 'toString', {
          value: function () {
            return '.' + oe
          },
        }),
        (se.withComponent = function (he, fe) {
          return ee(
            he,
            _extends$1$1({}, te, fe, {
              shouldForwardProp: composeShouldForwardProps(se, fe, !0),
            })
          ).apply(void 0, pe)
        }),
        se
...
function parseToRgb$1(ee) {
  ...
  var de = hslaRegex$1.exec(_.substring(0, 50))
  if (de) {
    var me = parseInt('' + de[1], 10),
      se = parseInt('' + de[2], 10) / 100,
      he = parseInt('' + de[3], 10) / 100,
      fe = 'rgb(' + hslToRgb$1(me, se, he) + ')',
...
var isRgb$1 = function (_) {
    return (
      ...
      (typeof _.alpha != 'number' || typeof _.alpha == 'undefined')
    )
  },
  isRgba$1 = function (_) {
    return (
...
`,
  ...
  convertColors = function (_) {
    return Object.entries(_).reduce(function (te, re) {
      ...
      return Object.assign(
        Object.assign({}, te),
        _defineProperty$6({}, ne, mkColor(oe))
      )
    }, {})
  },
  create = function (_) {
  ...
  convert = function () {
    ...
    return Object.assign(Object.assign({}, _e || {}), {
      ...
      animation,
      easing,
      input: {border: he, background: se, color: fe, borderRadius: ge},
      layoutMargin: 10,
      appBorderColor: oe,
      appBorderRadius: ie,
      barTextColor: pe,
      barSelectedColor: de || re,
      barBg: me,
      brand: {
        title: ve,
        url: ye,
    ...
    return ce
      ? ie.concat(
          ce.map(function (ue) {
            var pe, de
            return (de =
              (pe = ue.match(/[\t ]/g)) === null || pe === void 0
                ? void 0
                : pe.length) !== null && de !== void 0
              ? de
              : 0
          })
        )
...
function _iterableToArray$1(ee) {
  if (
    (typeof Symbol != 'undefined' && ee[Symbol.iterator] != null) ||
    ee['@@iterator'] != null
  )
    return Array.from(ee)
}
...
function __awaiter(ee, _, te, re) {
  ...
  return new (te || (te = Promise))(function (ne, oe) {
    ...
    function ce(ue) {
      ue.done ? ne(ue.value) : ae(ue.value).then(ie, le)
    }
...
function parseToRgb(ee) {
  ...
  var de = hslaRegex.exec(_.substring(0, 50))
  if (de) {
    var me = parseInt('' + de[1], 10),
      se = parseInt('' + de[2], 10) / 100,
      he = parseInt('' + de[3], 10) / 100,
      fe = 'rgb(' + hslToRgb(me, se, he) + ')',
      ge = rgbRegex.exec(fe)
...
var curriedTransparentize = curry(transparentize),
  ...
  LazySyntaxHighlighter = react.exports.lazy(function () {
    return __vitePreload(
      () => import('./syntaxhighlighter-82dea71a.2fa53c45.js'),
      [
        'assets/syntaxhighlighter-82dea71a.2fa53c45.js',
        'assets/iframe.b13c84ce.js',
      ]
    )
  }),
              ...
              case 0:
                return (
                  ...
                  Promise.all([
                    ...
                    __vitePreload(
                      () => import('./formatter-9dc562d4.7fe334a9.js'),
                      [
                        'assets/formatter-9dc562d4.7fe334a9.js',
                        'assets/iframe.b13c84ce.js',
                      ]
                    ),
                  ])
...
var SourceSkeletonWrapper = styled.div(function (ee) {
  ...
  Source$1 = function (_) {
    ...
    if (typeof ie == 'undefined') return ue
    var pe = ie ? themes.dark : themes.light
...
var Title$3 = styled.div(function (ee) {
  ...
  GlobalScrollAreaStyles = react.exports.lazy(function () {
    return __vitePreload(
      () => import('./GlobalScrollAreaStyles-8793ce4a.dc725ad9.js'),
      [
        'assets/GlobalScrollAreaStyles-8793ce4a.dc725ad9.js',
        'assets/iframe.b13c84ce.js',
      ]
    )
  }),
  OverlayScrollbars = react.exports.lazy(function () {
    return __vitePreload(
      () => import('./OverlayScrollbars-26c4a78d.a724cc42.js'),
      [
        'assets/OverlayScrollbars-26c4a78d.a724cc42.js',
        'assets/iframe.b13c84ce.js',
      ]
    )
  }),
...
function calculateNodeHeight(ee, _, te, re) {
  ...
  var ce = hiddenTextarea.scrollHeight - ae,
    ue = ce * te
  ie === 'border-box' && (ue = ue + ae + ne), (le = Math.max(ue, le))
  var pe = ce * re
  return (
    ie === 'border-box' && (pe = pe + ae + ne),
    (le = Math.min(pe, le)),
    [le, ce]
  )
}
var noop$2 = function () {},
  ...
  TextareaAutosize = function (_, te) {
    var re = _.cacheMeasurements,
      ...
      ue = _objectWithoutPropertiesLoose$3(_, [
        'cacheMeasurements',
        'maxRows',
        'minRows',
        'onChange',
      ...
      pe = ue.value !== void 0,
      de = react.exports.useRef(null),
      me = useComposedRef(de, te),
      se = react.exports.useRef(0),
    ...
    return (
      ...
      react.exports.createElement(
        'textarea',
        _extends$2({}, ue, {onChange: ge, ref: me})
      )
    )
  },
  index$2 = react.exports.forwardRef(TextareaAutosize),
  ...
  LazyWithTooltip = react.exports.lazy(function () {
    return __vitePreload(
      () => import('./WithTooltip-508b8277.ae2cdfc2.js'),
      ['assets/WithTooltip-508b8277.ae2cdfc2.js', 'assets/iframe.b13c84ce.js']
    ).then(function (ee) {
...
var Note = styled.div(function (ee) {
  ...
  ListItem = function (_) {
    var te = _.loading,
      ...
      me = getItemProps(ue, ce, pe),
      se = {active: ie, disabled: le}
    return React__default.createElement(
      Item$3,
      Object.assign({}, se, de, me),
      re && React__default.createElement(Left, Object.assign({}, se), re),
      ae || ne
        ? React__default.createElement(
            Center,
            null,
        ...
        : null,
      oe && React__default.createElement(Right, Object.assign({}, se), oe)
    )
  }
        ...
        render:
          typeof ue == 'function'
            ...
            : function (pe) {
                ...
                return React__default.createElement(
                  VisuallyHidden,
                  {key: me, active: de, role: 'tabpanel'},
                  ue
                )
              },
      }
              ...
              ce.map(function (ue) {
                ...
                return React__default.createElement(
                  TabButton,
                  {
                    ...
                    textColor: se,
                    onClick: function (ge) {
                      ge.preventDefault(), re.onSelect(de)
                    },
                    role: 'tab',
                  },
                  he
...
function Bt(ee) {
    ...
    return te.apply(
      ...
      [
        (function (ye, be) {
          ...
          return xe
            ? typeof xe == 'function' ||
              (_typeof(xe) == 'object' && 'render' in xe)
              ? xe
        ...
        e({}, se, he, {
          className:
            It(se == null ? void 0 : se.className, he.className) || void 0,
        }),
      ].concat(ge)
    )
  }
  function ae(me) {
    var se = !1
    _.forceInline ? (se = !0) : _.forceBlock || (se = P.test(me) === !1)
    for (
      var he = ue(
        ce(
          se
          ...
          if (ve !== -1) {
            var ye = (function (_e) {
                return (
                  _e.indexOf('-') !== -1 &&
                    _e.match(A$3) === null &&
                    (_e = _e.replace(j, function (Se, Ee) {
              ...
              xe = o[ye] || ye,
              $e = (he[xe] = (function (_e, Se) {
                return _e === 'style'
                  ? Se.split(/;\s?/).reduce(function (Ee, Te) {
                  ...
                  : _e === 'href'
                  ? bt(Se)
                  : (Se.match(I) && (Se = Se.slice(1, Se.length - 1)),
                    Se === 'true' || (Se !== 'false' && Se))
              })(ye, be))
            typeof $e == 'string' &&
              (w.test($e) || R.test($e)) &&
              (he[xe] = React__default.cloneElement(ae($e.trim()), {key: ge}))
  ...
  var oe = [],
    ...
    le = {
      blockQuote: {
        ...
        l: Ot.HIGH,
        _: function (se, he, fe) {
          return {content: he(se[0].replace(_2, ''), fe)}
        },
        p: function (se, he, fe) {
          return re('blockquote', {key: fe.g}, he(se.content, fe))
        },
      },
      breakLine: {
        i: xt(f),
      ...
      codeBlock: {
        ...
        _: function (se) {
          return {
            content: se[0].replace(/^ {4}/gm, '').replace(/\n+$/, ''),
            lang: void 0,
          }
        },
        p: function (se, he, fe) {
          return re(
            ...
            re(
              'code',
              {className: se.lang ? 'lang-'.concat(se.lang) : ''},
              se.content
            )
          )
        },
      ...
      codeFenced: {
        ...
        l: Ot.MAX,
        _: function (se) {
          return {content: se[3], lang: se[2] || void 0, type: 'codeBlock'}
        },
      },
      codeInline: {
        i: ht(m),
        ...
        p: function (se, he, fe) {
          return re('code', {key: fe.g}, se.content)
        },
      },
      footnote: {
        i: kt(k),
        l: Ot.MAX,
        _: function (se) {
          return oe.push({footnote: se[2], identifier: se[1]}), {}
        },
        p: Rt,
      },
      footnoteReference: {
        ...
        l: Ot.HIGH,
        _: function (se) {
          return {content: se[1], target: '#'.concat(_.slugify(se[1]))}
        },
        p: function (se, he, fe) {
          return re(
            'a',
            {key: fe.g, href: bt(se.target)},
            re('sup', {key: fe.g}, se.content)
          )
        },
      },
      gfmTask: {
        ...
        l: Ot.HIGH,
        _: function (se) {
          return {completed: se[1].toLowerCase() === 'x'}
        },
        p: function (se, he, fe) {
          return re('input', {
      ...
      heading: {
        ...
        p: function (se, he, fe) {
          return (
            (se.tag = 'h'.concat(se.level)),
            re(se.tag, {id: se.id, key: fe.g}, he(se.content, fe))
          )
        },
      },
      headingSetext: {
      ...
      image: {
        ...
        l: Ot.HIGH,
        _: function (se) {
          return {alt: se[1], target: St(se[2]), title: se[3]}
        },
        p: function (se, he, fe) {
          return re('img', {
            key: fe.g,
            alt: se.alt || void 0,
            title: se.title || void 0,
            src: bt(se.target),
          })
        },
      },
      link: {
        ...
        l: Ot.LOW,
        _: function (se, he, fe) {
          return {content: wt(he, se[1], fe), target: St(se[2]), title: se[3]}
        },
        p: function (se, he, fe) {
          return re(
            'a',
            {key: fe.g, href: bt(se.target), title: se.title},
            he(se.content, fe)
          )
        },
      },
      linkAngleBraceStyleDetector: {
        ...
        _: function (se) {
          return {
            content: [{content: se[1], type: 'text'}],
            target: se[1],
            type: 'link',
          }
        },
      ...
      list: {
        i: function (se, he, fe) {
          var ge = T.exec(fe)
          return !ge || (!he.h && he.o) ? null : at.exec((se = ge[1] + se))
        },
        l: Ot.HIGH,
        _: function (se, he, fe) {
          var ge = se[2],
...
`
          ...
          return {
            items: be.map(function ($e, _e) {
              var Se = ot.exec($e)[0].length,
                Ee = new RegExp('^ {1,' + Se + '}', 'gm'),
...
`
        ...
        p: function (se, he, fe) {
          return re(
            se.ordered ? 'ol' : 'ul',
            {key: fe.g, start: se.start},
            se.items.map(function (ge, ve) {
...
`
      ...
      paragraph: {
        ...
        _: Et,
        p: function (se, he, fe) {
          return re('p', {key: fe.g}, he(se.content, fe))
        },
      },
      ref: {
        i: yt(D),
        l: Ot.MAX,
        _: function (se) {
          return (ie[se[1]] = {target: se[2], title: se[4]}), {}
        },
        p: Rt,
      },
      refImage: {
        ...
        l: Ot.MAX,
        _: function (se) {
          return {alt: se[1] || void 0, ref: se[2]}
        },
        p: function (se, he, fe) {
          return re('img', {
            key: fe.g,
            alt: se.alt,
            src: bt(ie[se.ref].target),
            title: ie[se.ref].title,
          })
        },
      },
      refLink: {
        ...
        _: function (se, he, fe) {
          return {
            content: he(se[1], fe),
            fallbackContent: he(se[0].replace(F, '\\$1'), fe),
            ref: se[2],
          }
        },
        p: function (se, he, fe) {
          return ie[se.ref]
            ? re(
                ...
                {
                  key: fe.g,
                  href: bt(ie[se.ref].target),
                  title: ie[se.ref].title,
                },
                he(se.content, fe)
              )
            : re('span', {key: fe.g}, he(se.fallbackContent, fe))
        },
      },
      table: {
        i: kt(C),
          ...
          return re(
            ...
            re(
              ...
              re(
                'tr',
                null,
                se.header.map(function (ge, ve) {
                  return re('th', {key: ve, style: mt(se, ve)}, he(ge, fe))
                })
              )
            ),
            re(
              'tbody',
              null,
              se.cells.map(function (ge, ve) {
                return re(
                  'tr',
                  {key: ve},
                  ge.map(function (ye, be) {
                    return re('td', {key: be, style: mt(se, be)}, he(ye, fe))
                  })
                )
              })
            )
      ...
      text: {
        ...
        _: function (se) {
          return {
            content: se[0].replace(z, function (he, fe) {
      ...
      textBolded: {
        ...
        l: Ot.MED,
        _: function (se, he, fe) {
          return {content: he(se[2], fe)}
        },
        p: function (se, he, fe) {
          return re('strong', {key: fe.g}, he(se.content, fe))
        },
      },
      textEmphasized: {
        i: ht(J),
        ...
        p: function (se, he, fe) {
          return re('em', {key: fe.g}, he(se.content, fe))
        },
      },
      textEscaped: {
        i: ht(Y),
      ...
      textStrikethroughed: {
        ...
        _: Et,
        p: function (se, he, fe) {
          return re('del', {key: fe.g}, he(se.content, fe))
        },
      },
    }
    ...
    ((le.htmlBlock = {
      ...
      p: function (se, he, fe) {
        return re(
          se.tag,
          e({key: fe.g}, se.attrs),
          se.noInnerParse ? se.content : he(se.content, fe)
        )
      },
    }),
    (le.htmlSelfClosing = {
      ...
      l: Ot.HIGH,
      _: function (se) {
        return {attrs: ne(se[2] || ''), tag: se[1]}
      },
      p: function (se, he, fe) {
        return re(se.tag, e({}, se.attrs, {key: fe.g}))
      },
    }))
  var ce = (function (me) {
      var se = Object.keys(me)
      function he(fe, ge) {
        for (var ve = [], ye = ''; fe; )
          for (var be = 0; be < se.length; ) {
            var xe = se[be],
              $e = me[xe],
              _e = $e.i(fe, ge, ye)
            if (_e) {
              var Se = _e[0]
              fe = fe.substring(Se.length)
              var Ee = $e._(_e, he, ge)
              Ee.type == null && (Ee.type = xe), ve.push(Ee), (ye = Se)
              break
            }
            be++
          }
...
`
    ...
    ue =
      ((pe = (function (me) {
        return function (se, he, fe) {
          return me[se.type].p(se, he, fe)
        }
      })(le)),
      function me(se) {
        var he =
        ...
        if (Array.isArray(se)) {
          for (var fe = he.g, ge = [], ve = !1, ye = 0; ye < se.length; ye++) {
            he.g = ye
            var be = me(se[ye], he),
              xe = typeof be == 'string'
            xe && ve ? (ge[ge.length - 1] += be) : be !== null && ge.push(be),
              (ve = xe)
          }
          return (he.g = fe), ge
        }
...
var Markdown = function (_) {
    var te = _.children,
      ...
      ae = (function (ne, oe) {
        ...
        for (le = 0; le < ue.length; le++)
          oe.indexOf((ie = ue[le])) >= 0 || (ce[ie] = ne[ie])
        return ce
      })(_, r)
  ...
  breakpoint = 600,
  Title$2 = styled.h1(withReset, function (ee) {
    var _ = ee.theme
    return _defineProperty2(
      {
        color: _.color.defaultText,
  ...
  Subtitle$1 = styled.h2(withReset, function (ee) {
    var _,
      te = ee.theme
    return (
      (_ = {
  ...
  PureLoader = function (_) {
    ...
    if (re)
      return React__default.createElement(
        ProgressWrapper,
        Object.assign(
          {'aria-label': re.toString(), 'aria-live': 'polite', role: 'status'},
          ne
        ),
        ...
        if (!(CONFIG_TYPE !== 'DEVELOPMENT' || !EventSource)) {
          ...
          return (
            (ue.onmessage = function (de) {
              try {
                ;(pe = JSON.parse(de.data)), ne(pe)
              } catch (me) {
                ce(me), ue.close()
              }
            }),
            (ue.onerror = function () {
              pe && pe.value !== 1 && ce(new Error('Connection closed')),
                ue.close()
            }),
            function () {
              return ue.close()
...
var PositionedToolbar = styled(Toolbar)({
  ...
  Preview$1 = function (_) {
    var te = _.isLoading,
      ...
      se = react.exports.useState(ue),
      he = _slicedToArray$4(se, 2),
      fe = he[0],
      ge = he[1],
      ...
      $e = _slicedToArray$4(xe, 2),
      _e = $e[0],
      Se = $e[1],
      Ee = [de].concat(['sbdocs', 'sbdocs-preview']),
      Te = oe ? [be] : [],
      Ce = react.exports.useState(pe ? _toConsumableArray$1(pe) : []),
      Ae = _slicedToArray$4(Ce, 2),
      we = Ae[0],
      Re = Ae[1],
      Oe = [].concat(Te, _toConsumableArray$1(we)),
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          Relative,
          {className: 'docs-story', onCopyCapture: oe && Ne},
          React__default.createElement(
            ChildrenContainer,
...
function equalArrays$2(ee, _, te, re, ae, ne) {
  ...
  var ce = ne.get(ee),
    ue = ne.get(_)
  if (ce && ue) return ce == _ && ue == ee
  var pe = -1,
    de = !0,
    me = te & COMPARE_UNORDERED_FLAG$3 ? new SetCache$1() : void 0
  for (ne.set(ee, _), ne.set(_, ee); ++pe < ie; ) {
    var se = ee[pe],
      he = _[pe]
    if (re) var fe = oe ? re(he, se, pe, _, ee, ne) : re(se, he, pe, ee, _, ne)
    if (fe !== void 0) {
      if (fe) continue
      de = !1
      break
    ...
    if (me) {
      if (
        !arraySome(_, function (ge, ve) {
          if (!cacheHas$1(me, ve) && (se === ge || ae(se, ge, te, re, ne)))
            return me.push(ve)
        })
      ) {
        de = !1
    ...
    } else if (!(se === he || ae(se, he, te, re, ne))) {
      de = !1
      break
    }
  }
  return ne.delete(ee), ne.delete(_), de
}
...
function equalByTag$1(ee, _, te, re, ae, ne, oe) {
  switch (te) {
    ...
    case setTag$5:
      ...
      var ue = equalArrays$1(ie(ee), ie(_), re, ae, ne, oe)
      return oe.delete(ee), ue
    case symbolTag$3:
      if (symbolValueOf$1)
...
function isArrayLike$2(ee) {
  return ee != null && isLength$1(ee.length) && !isFunction$3(ee)
}
...
function equalObjects$1(ee, _, te, re, ae, ne) {
  ...
  for (var pe = le; pe--; ) {
    var de = ie[pe]
    if (!(oe ? de in _ : hasOwnProperty$4.call(_, de))) return !1
  }
  var me = ne.get(ee),
    se = ne.get(_)
  if (me && se) return me == _ && se == ee
  var he = !0
  ...
  for (var fe = oe; ++pe < le; ) {
    ...
    var ge = ee[de],
      ve = _[de]
    if (re) var ye = oe ? re(ve, ge, de, _, ee, ne) : re(ge, ve, de, ee, _, ne)
    if (!(ye === void 0 ? ge === ve || ae(ge, ve, te, re, ne) : ye)) {
      he = !1
      break
    }
    fe || (fe = de == 'constructor')
  }
  if (he && !fe) {
...
function baseIsEqualDeep$1(ee, _, te, re, ae, ne) {
  ...
  if (!(te & COMPARE_PARTIAL_FLAG$2)) {
    var me = ue && hasOwnProperty$3.call(ee, '__wrapped__'),
      se = pe && hasOwnProperty$3.call(_, '__wrapped__')
    if (me || se) {
...
function baseIsMatch$1(ee, _, te, re) {
  ...
  for (; ++ae < ne; ) {
    ...
    if (oe && ie[2]) {
      ...
      var pe = new Stack$1()
      if (re) var de = re(ce, ue, le, ee, _, pe)
      if (
        !(de === void 0
          ? baseIsEqual$1(
              ue,
...
function baseSet$1(ee, _, te, re) {
  ...
  for (
    ...
    if (ae != oe) {
      var ue = ie[le]
      ;(ce = re ? re(ue, le, ie) : void 0),
        ce === void 0 &&
          (ce = isObject$3(ue) ? ue : isIndex(_[ae + 1]) ? [] : {})
    }
...
function baseUniq$1(ee, _, te) {
  ...
  e: for (; ++re < ne; ) {
    var ue = ee[re],
      pe = _ ? _(ue) : ue
    if (((ue = te || ue !== 0 ? ue : 0), oe && pe === pe)) {
      for (var de = le.length; de--; ) if (le[de] === pe) continue e
      _ && le.push(pe), ie.push(ue)
    } else ae(le, pe, te) || (le !== ie && le.push(pe), ie.push(ue))
  }
  return ie
}
...
var uniq_1 = uniq,
  ...
  ArgSummary = function (_) {
    ...
    var se = typeof ae.toString == 'function' ? ae.toString() : ae
    if (ne == null) {
      var he = /[(){}[\]<>]/.test(se)
      if (he) return React__default.createElement(ArgText, {text: se})
      var fe = getSummaryItems(se),
        ge = fe.length,
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement('span', null, se),
    ...
    react.exports.useEffect(
      function () {
        ce !== !1 &&
          ...
          de && de.current && (de.current.value = formatTime(re)))
      },
      [re]
    )
    var me = function (ge) {
  ...
  NumberControl = function (_) {
    var te = _.name,
      ...
      $e = react.exports.useCallback(
        function (Ee) {
          ...
          Number.isNaN(Te)
            ? xe(new Error("'".concat(Ee.target.value, "' is not a number")))
            : (ae(Te), xe(null))
        },
        [ae, xe]
      ),
    ...
    return (
      react.exports.useEffect(
        function () {
          fe && Se.current && Se.current.select()
        },
        [fe]
      ),
      react.exports.useEffect(
        ...
        : React__default.createElement(
            ...
            React__default.createElement(
              ...
              Object.assign(
                ...
                {name: te, min: ne, max: oe, step: ie, onFocus: ce, onBlur: le}
              )
            )
          )
    )
...
var selectedKey = function (_, te) {
  ...
  CheckboxControl = function (_) {
    ...
    return React__default.createElement(
      Wrapper$4,
      {isInline: oe},
      Object.keys(re).map(function (se, he) {
        ...
        return React__default.createElement(
          ...
          React__default.createElement('input', {
            ...
            value: se,
            onChange: de,
            checked: ue == null ? void 0 : ue.includes(se),
          }),
          React__default.createElement(Text$1, null, se)
        )
      })
    )
  },
...
var Text = styled.span({}),
  ...
  RadioControl = function (_) {
    ...
    return React__default.createElement(
      Wrapper$3,
      {isInline: oe},
      Object.keys(re).map(function (ce, ue) {
        var pe = ''.concat(le, '-').concat(ue)
        return React__default.createElement(
          Label$1,
          {key: pe, htmlFor: pe},
          React__default.createElement('input', {
...
;(function (ee, _) {
  ...
  function le(ce, ue) {
    ...
    var pe = ce.length,
      de = ie ? ie(pe) : new ce.constructor(pe)
...
function baseClone$1(ee, _, te, re, ae, ne) {
  ...
  var se = ce ? (le ? getAllKeysIn : getAllKeys) : le ? keysIn : keys,
    he = ue ? void 0 : se(ee)
  return (
    ...
    _createClass(te, [
      ...
      },
      {
        ...
        value: function () {
          ...
          ;(me.newValue = ie(!1, le, ce, me.key, de.value)), ne(me)
        },
      },
      {
        key: 'refInputKey',
      ...
      },
      {
        ...
        value: function () {
          var ae = this.props,
            ...
            ue = ae.keyPath,
            pe = ae.deep,
            de = react.exports.cloneElement(ie, {onClick: this.onSubmit}),
            me = react.exports.cloneElement(le, {onClick: ne}),
            se = ce(VALUE, ue, pe),
            he = react.exports.cloneElement(se, {
              placeholder: 'Value',
            ...
            return function () {
              ...
              ie(ae, pe, de, me)
                .then(function () {
                  ...
                  ue.splice(ae, 1), ne.setState({data: ue})
                  var he = ne.props,
                    fe = he.onUpdate,
                    ge = he.onDeltaUpdate
                  fe(pe[pe.length - 1], ue), ge(se)
                })
                .catch(le.error)
            }
          },
        },
        {
          ...
          value: function (ae) {
            var ne = this,
              ...
              ue = ie.nextDeep,
              pe = this.props,
              de = pe.beforeAddAction,
              me = pe.logger
            de(le.length, ce, ue, oe)
              .then(function () {
                var se = [].concat(_toConsumableArray$1(le), [oe])
                ne.setState({data: se}), ne.handleAddValueCancel()
                var he = ne.props,
                  fe = he.onUpdate,
                  ge = he.onDeltaUpdate
                fe(ce[ce.length - 1], se),
                  ge({
                    type: ADD_DELTA_TYPE,
                    keyPath: ce,
                    deep: ue,
        ...
        },
        {
          ...
          value: function (ae) {
            ...
            return new Promise(function (le, ce) {
              ...
              ue(oe, me, se, he, ie)
                .then(function () {
                  ;(de[oe] = ie), ne.setState({data: de})
                  var fe = ne.props,
                    ge = fe.onUpdate,
                    ve = fe.onDeltaUpdate
                  ge(me[me.length - 1], de),
                    ve({
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              de = ce.getStyle,
              me = ce.dataType,
              se = ce.minusMenuElement,
              he = de(ne, oe, ie, le, me),
              fe = he.minus,
              ge = he.collapsed,
              ve = pe(ne, oe, ie, le, me),
              ye = react.exports.cloneElement(se, {
                onClick: ue,
        ...
        },
        {
          ...
          value: function () {
            var ae = this,
              ...
              ge = de.getStyle,
              ve = de.dataType,
              ye = de.addButtonElement,
              be = de.cancelButtonElement,
              xe = de.editButtonElement,
              $e = de.inputElementGenerator,
              _e = de.textareaElementGenerator,
              Se = de.minusMenuElement,
              Ee = de.plusMenuElement,
              Te = de.beforeRemoveAction,
              Ce = de.beforeAddAction,
              Ae = de.beforeUpdateAction,
              we = de.logger,
              Re = de.onSubmitValueParser,
              ...
              Be = react.exports.cloneElement(Se, {
                onClick: se,
                className: 'rejt-minus-menu',
                style: Le,
              }),
              ...
              React__default.createElement(
                ...
                ie.map(function (Ve, Pe) {
                  return React__default.createElement(JsonNode, {
                    ...
                    deep: pe,
                    isCollapsed: me,
                    handleRemove: ae.handleRemoveItem(Pe),
      ...
      [
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              de = pe.readOnly,
              me = pe.dataType,
              se = de(ie, le, ce, ue, me)
            ne && !se && typeof oe.focus == 'function' && oe.focus()
          },
        },
        {
          key: 'componentDidMount',
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              se = ue.dataType,
              he = ue.getStyle,
              fe = ue.editButtonElement,
              ge = ue.cancelButtonElement,
              ve = ue.textareaElementGenerator,
              ye = ue.minusMenuElement,
              be = ue.keyPath,
              xe = he(ne, de, le, ce, se),
              $e = null,
              _e = null,
              Se = me(ne, de, le, ce, se)
            if (ie && !Se) {
              var Ee = ve(VALUE, be, ce, ne, de, se),
                Te = react.exports.cloneElement(fe, {onClick: this.handleEdit}),
              ...
              var we = react.exports.cloneElement(ye, {
                onClick: pe,
                className: 'rejt-minus-menu',
                style: xe.minus,
              })
      ...
      [
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              xe = ce.textareaElementGenerator,
              $e = ce.minusMenuElement,
              _e = ce.plusMenuElement,
              Se = ce.beforeRemoveAction,
            ...
            return function () {
              ...
              ie(ae, pe, de, me)
                .then(function () {
                  ...
                  delete ue[ae], ne.setState({data: ue})
                  var he = ne.props,
                    fe = he.onUpdate,
                    ge = he.onDeltaUpdate
                  fe(pe[pe.length - 1], ue), ge(se)
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              me = ce.getStyle,
              se = ce.minusMenuElement,
              he = me(ne, le, oe, ie, de),
              fe = he.minus,
              ge = he.collapsed,
              ve = Object.getOwnPropertyNames(le),
              ye = pe(ne, le, oe, ie, de),
              be = react.exports.cloneElement(se, {
                onClick: ue,
                className: 'rejt-minus-menu',
                style: fe,
        ...
        },
        {
          ...
          value: function () {
            var ae = this,
              ...
              Fe = react.exports.cloneElement(Se, {
                onClick: se,
                className: 'rejt-minus-menu',
                style: Le,
              }),
              ze = Ie.map(function (Pe) {
                return React__default.createElement(JsonNode, {
                  key: Pe,
                  name: Pe,
                  data: ie[Pe],
                  ...
                  deep: ue,
                  isCollapsed: me,
                  handleRemove: ae.handleRemoveValue(Pe),
                  handleUpdateValue: ae.handleEditValue,
                  onUpdate: ae.onChildUpdate,
                  onDeltaUpdate: he,
                  readOnly: fe,
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              ue = ie.readOnly,
              pe = ie.getStyle,
              de = ie.addButtonElement,
              me = ie.cancelButtonElement,
              se = ie.editButtonElement,
              he = ie.inputElement,
              ...
              xe = ie.beforeUpdateAction,
              $e = ie.logger,
              _e = ie.onSubmitValueParser,
              Se = ie.fallback,
              Ee = Se === void 0 ? null : Se,
              Te = getObjectType(ne),
              Ce = ue
...
var globalWindow$3 = window_1.window,
  ...
  ObjectControl = function ee(_) {
    var te = _.name,
      ...
      ue = ce[0],
      pe = ce[1],
      de = react.exports.useState(null),
...
var RangeControl = function ee(_) {
  ...
  TextControl = function ee(_) {
    ...
    if (re === void 0)
      return React__default.createElement(
        Form.Button,
        {id: getControlSetterButtonId(te), onClick: de},
        'Set string'
      )
...
var FilesControl = function ee(_) {
    ...
    function ie(le) {
      if (!!le.target.files) {
        var ce = Array.from(le.target.files).map(function (ue) {
  ...
  LazyColorControl = react.exports.lazy(function () {
    return __vitePreload(
      () => import('./Color-3c22bb81.988f4e8a.js'),
      ['assets/Color-3c22bb81.988f4e8a.js', 'assets/iframe.b13c84ce.js']
    )
  }),
  ...
  ArgControl = function ee(_) {
    ...
    var he = react.exports.useCallback(
        function (be) {
          return se({value: be}), ae(_defineProperty2({}, ne, be)), be
        },
        [ae, ne]
      ),
  ...
  ArgRow = function ee(_) {
    var te,
      ...
      ue = re.table || {},
      pe = ue.type || re.type,
      de = ue.defaultValue || re.defaultValue,
  ...
  SectionRow = function ee(_) {
    var te = _.level,
      ...
      le = _.colSpan,
      ce = le === void 0 ? 3 : le,
      ue = react.exports.useState(ie),
      pe = _slicedToArray$4(ue, 2),
      de = pe[0],
      me = pe[1],
      se = re === 'subsection' ? Subsection : Section,
      he = (ne == null ? void 0 : ne.length) || 0,
      fe =
        re === 'subsection'
          ? ''.concat(he, ' item').concat(he !== 1 ? 's' : '')
          : '',
      ge = de ? 'arrowdown' : 'arrowright',
      ve = ''
        .concat(de ? 'Hide' : 'Show', ' ')
...
var sortFns = {
  ...
  groupRows = function ee(_, te) {
    ...
    Object.entries(_).forEach(function (ie) {
      var le = _slicedToArray$4(ie, 2),
        ...
        me = pe.subcategory
      if (de) {
        var se = re.sections[de] || {ungrouped: [], subsections: {}}
        if (!me) se.ungrouped.push(Object.assign({key: ce}, ue))
        else {
          var he = se.subsections[me] || []
          he.push(Object.assign({key: ce}, ue)), (se.subsections[me] = he)
        }
        re.sections[de] = se
      } else if (me) {
        var fe = re.ungroupedSubsections[me] || []
        fe.push(Object.assign({key: ce}, ue)),
          (re.ungroupedSubsections[me] = fe)
      } else re.ungrouped.push(Object.assign({key: ce}, ue))
    })
    var ae = sortFns[te],
      ne = function (le) {
        return ae
          ? Object.keys(le).reduce(function (ce, ue) {
              return Object.assign(
                Object.assign({}, ce),
                _defineProperty2({}, ue, le[ue].sort(ae))
              )
            }, {})
          : le
      },
  ...
  ArgsTable$1 = function ee(_) {
      ...
      se = groupRows(
        pickBy_1(pe, function (ve) {
          ...
          return (
            ...
            ) && safeIncludeConditionalArg(ve, de || {}, me || {})
          )
        }),
        le
      )
    if (
      se.ungrouped.length === 0 &&
      Object.entries(se.sections).length === 0 &&
      Object.entries(se.ungroupedSubsections).length === 0
    )
      return React__default.createElement(
        EmptyBlock,
        null,
    ...
    var he = 1
    te && (he += 1), ae || (he += 2)
    var fe = Object.keys(se.sections).length > 0,
      ge = {
        updateArgs: te,
        compact: ae,
        inAddonPanel: ne,
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          se.ungrouped.map(function (ve) {
            return React__default.createElement(
              ArgRow,
              Object.assign({key: ve.key, row: ve, arg: de && de[ve.key]}, ge)
            )
          }),
          Object.entries(se.ungroupedSubsections).map(function (ve) {
          ...
          Object.entries(se.sections).map(function (ve) {
            var ye = _slicedToArray$4(ve, 2),
              be = ye[0],
              xe = ye[1]
            return React__default.createElement(
              ...
              xe.ungrouped.map(function ($e) {
                return React__default.createElement(
                  ArgRow,
                  Object.assign(
                    {key: $e.key, row: $e, arg: de && de[$e.key]},
                    ge
                  )
                )
              }),
              Object.entries(xe.subsections).map(function ($e) {
                var _e = _slicedToArray$4($e, 2),
                  Se = _e[0],
                  Ee = _e[1]
                return React__default.createElement(
                  SectionRow,
                  {key: Se, label: Se, level: 'subsection', colSpan: he},
                  Ee.map(function (Te) {
                    return React__default.createElement(
                      ArgRow,
                      Object.assign(
...
var Label = styled.div(function (ee) {
  ...
  Wrapper$9 = styled.div(withReset, function (ee) {
    var _ = ee.theme
...
function _defineProperty$4(ee, _, te) {
  return (
    _ in ee
      ? Object.defineProperty(ee, _, {
          value: te,
...
function _objectWithoutProperties$2(ee, _) {
  if (ee == null) return {}
  var te = _objectWithoutPropertiesLoose$2(ee, _),
    re,
    ae
  if (Object.getOwnPropertySymbols) {
...
var isFunction = function ee(_) {
    return typeof _ == 'function'
  },
  MDXContext = React__default.createContext({}),
  useMDXComponents = function ee(_) {
  ...
  DEFAULTS = {
    inlineCode: 'code',
    wrapper: function ee(_) {
      var te = _.children
      return React__default.createElement(React__default.Fragment, {}, te)
    },
  },
  MDXCreateElement = React__default.forwardRef(function (ee, _) {
    ...
    return te
      ? React__default.createElement(
          ce,
          _objectSpread2(_objectSpread2({ref: _}, oe), {}, {components: te})
        )
      : React__default.createElement(ce, _objectSpread2({ref: _}, oe))
  })
                ...
                return regeneratorRuntime.wrap(function (de) {
                  for (;;)
                    switch ((de.prev = de.next)) {
                      case 0:
                        return (de.next = 2), _.loadStory(ce)
                      case 2:
                        ;(ue = de.sent),
                          oe(function (me) {
                            return me[ce] === ue
...
var storyBlockIdFromId = function ee(_) {
  ...
  getStoryProps = function ee(_, te, re, ae) {
    ...
    var pe = ue.inlineStories,
      ...
      me = ue.iframeHeight,
      se = me === void 0 ? 100 : me,
      he = ue.prepareForInline,
      fe = typeof oe == 'boolean' ? oe : de
    if (fe && !he)
      throw new Error(
        "Story '".concat(
          ie,
    ...
    return Object.assign(
      {inline: fe, id: te.id, height: ne || (fe ? void 0 : se), title: ie},
      fe && {
        parameters: le,
        storyFn: function () {
...
var Story = function ee(_) {
  ...
  react.exports.useEffect(
    function () {
      ...
      if (oe && ae.current) {
        var Se = ae.current
        ;(_e = te.renderStoryToElement(oe, Se)), ue(!1)
      }
      return function () {
        return _e && _e()
      }
  ...
  var ye = getStoryProps(_, oe, te, se)
  if (!ye) return null
  if (ye.inline) {
    var be
    if (
...
var getContext = function ee(_, te) {
  ...
  getComponent = function ee() {
    var _ = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      ...
      ce = ae(re),
      ue = ce.component
    if (isShortcut(oe) || isShortcut(le)) return ue || null
  ...
  StoryTable = function ee(_) {
    ...
    try {
      ...
      switch (ne) {
        ...
        default:
          de = lookupStoryId(ne, te)
      }
      var se = useStory(de, te),
        he = useArgs(de, te),
        ...
        ye = fe[2],
        be = useGlobals(de, te),
        xe = _slicedToArray$1(be, 1),
        $e = xe[0]
      if (!se)
        return jsx(ArgsTable$1, {isLoading: !0, updateArgs: ve, resetArgs: ye})
      var _e = filterArgTypes(se.argTypes, ce, ue),
        Se = getComponentName(oe) || 'Story',
        Ee = _defineProperty$2({}, Se, {
          rows: _e,
          args: ge,
          globals: $e,
          updateArgs: ve,
      ...
      if (
        ...
        Ee = addComponentTabs(Ee, ie, te, ce, ue)
      }
      return jsx(TabbedArgsTable, {tabs: Ee, sort: pe})
    } catch (Ce) {
  ...
  ArgsTable = function ee(_) {
    var te = react.exports.useContext(DocsContext),
      ...
      me = _,
      se = me.story,
      he = de || (oe == null ? void 0 : oe.sort),
      fe = getComponent(_, te)
    if (se)
      return jsx(StoryTable, {..._, component: fe, subcomponents: ie, sort: he})
    if (!pe && !ie) {
      var ge
      try {
        ge = {rows: extractComponentArgTypes(fe, te, ce, ue)}
      } catch (ye) {
        ge = {error: ye.message}
      }
      return jsx(ArgsTable$1, {...ge, sort: he})
    }
    if (pe) return jsx(ComponentsTable, {..._, components: pe, sort: he})
          ...
          ;(ne[ue] && ne[ue].code === pe) ||
            oe(function (me) {
              var se = Object.assign(
                {},
                me,
                _defineProperty$1({}, ue, {code: pe, format: de})
              )
              return fastDeepEqual(me, se) ? me : se
            })
        }
        return (
...
`)
  ...
  enhanceSource = function ee(_) {
    ...
    var ce = extract(re, ne),
      ue = le ? le(ce, _) : ce
    return {docs: combineParameters(ie, {source: {code: ue}})}
  },
  SourceState
;(function (ee) {
...
var getSourceState = function ee(_) {
  ...
  getSourceProps = function ee(_, te, re) {
    ...
    if (!pe) {
      var fe = getStorySource(se[0], re)
      ;(de = fe.format),
        (pe = se.map(function (Se, Ee) {
          var Te = getStorySource(Se, re),
            Ce = Te.code,
            Ae = he[Ee]
...
var getPreviewProps = function ee(_, te, re) {
    var ae = _.withSource,
      ...
      ue = ae,
      pe = !1
    if (ue === SourceState.NONE) return {isLoading: pe, previewProps: ie}
    if (ne)
      return {
        isLoading: pe,
    ...
    var de = Array.isArray(oe) ? oe : [oe],
      me = de.filter(function (ve) {
        return ve.props && (ve.props.id || ve.props.name)
      }),
      se = me.map(function (ve) {
        return (
          ve.props.id ||
          dist.toId(
            le.id || le.title,
      ...
      he = getSourceProps({ids: se}, te, re)
    ue || (ue = he.state)
    var fe = se.map(function (ve) {
        return ve === CURRENT_SELECTION ? te.id : ve
      }),
      ge = useStories(fe, te)
    return (
      (pe = ge.some(function (ve) {
        return !ve
      })),
      {
        isLoading: pe,
  ...
  getDescriptionProps = function ee(_, te) {
    ...
    switch (ae) {
      ...
      case DescriptionType.NOTES:
        return {markdown: getNotes(de)}
      case DescriptionType.LEGACY_5_2:
        return {
          markdown: `
`
            .concat(
              getNotes(de) || getInfo(me) || '',
              `
...
`
      ...
      default:
        return {markdown: ge(ye, Object.assign({component: ue}, pe))}
    }
  },
...
var STORY_KIND_PATH_SEPARATOR = /\s*\/\s*/,
  extractTitle = function ee(_) {
    var te = _.title,
      re = te.trim().split(STORY_KIND_PATH_SEPARATOR)
    return (re && re[re.length - 1]) || te
  },
  Title = function ee(_) {
    var te = _.children,
      re = react.exports.useContext(DocsContext),
      ae = te
    return (
      ae || (ae = extractTitle(re)),
      ae ? jsx(Title$2, {className: 'sbdocs-title', children: ae}) : null
    )
  },
  Subtitle = function ee(_) {
    var te = _.children,
      re = react.exports.useContext(DocsContext),
      ae = re.id,
      ne = re.storyById,
      ...
      le = te
    return (
      le || (le = ie == null ? void 0 : ie.componentSubtitle),
      le ? jsx(Subtitle$1, {className: 'sbdocs-subtitle', children: le}) : null
    )
  },
  _excluded = ['children'],
...
var document$3 = window_1$2.document,
  ...
  CodeOrSourceMdx = function ee(_) {
    ...
    if (
      ...
      return React__default.createElement(Code, null, re)
    var ne = te && te.split('-')
    return React__default.createElement(
      Source$1,
      _extends(
        {language: (ne && ne[1]) || 'plaintext', format: !1, code: re},
        ae
      )
    )
  }
...
var A = components.a,
  ...
  AnchorMdx = function ee(_) {
    ...
    if (te) {
      if (te.startsWith('#'))
        return React__default.createElement(AnchorInPage, {hash: te}, ae)
    ...
    return React__default.createElement(A, _)
  },
  ...
  HeaderMdx = function ee(_) {
    ...
    if (re)
      return React__default.createElement(
        ...
        _extends({as: te, id: re}, ne),
        ae
      )
    var oe = components[te]
    return React__default.createElement(oe, _)
  },
  HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(function (ee, _) {
    return Object.assign(
      ...
      _defineProperty({}, _, function (te) {
        return React__default.createElement(HeaderMdx, _extends({as: _}, te))
      })
    )
  }, {}),
  Subheading = function ee(_) {
    ...
    if (re || typeof te != 'string')
      return React__default.createElement(H3, null, te)
    var ae = te.toLowerCase().replace(/[^a-z0-9]/gi, '-')
    return React__default.createElement(HeaderMdx, {as: 'h3', id: ae}, te)
  },
  _templateObject$3
...
var warnStoryDescription = browser(
  ...
  DocsStory = function ee(_) {
    ...
    if (ne && pe) {
      var de
      ;(ue =
        (de = pe.description) === null || de === void 0 ? void 0 : de.story),
    ...
    return React__default.createElement(
      Anchor,
      {storyId: te},
      me && React__default.createElement(Subheading, null, me),
      ue && React__default.createElement(DescriptionContainer, {markdown: ue}),
      React__default.createElement(
        Canvas,
        {withToolbar: ie},
        React__default.createElement(Story, {id: te, parameters: ce})
      )
    )
  },
  Primary = function ee(_) {
    var te = _.name,
      re = react.exports.useContext(DocsContext),
      ae = re.componentStories,
      ne = ae(),
      oe
    return (
      ne &&
        (oe = te
          ...
          : ne[0]),
      oe ? jsx(DocsStory, {...oe, expanded: !1, withToolbar: !0}) : null
    )
  },
  Heading = function ee(_) {
    var te = _.children,
      re = _.disableAnchor
    if (re || typeof te != 'string')
      return React__default.createElement(H2, null, te)
    var ae = te.toLowerCase().replace(/[^a-z0-9]/gi, '-')
    return React__default.createElement(HeaderMdx, {as: 'h2', id: ae}, te)
  },
...
var DocsPage = function ee() {
    return React__default.createElement(
      React__default.Fragment,
      null,
      React__default.createElement(Title, null),
      React__default.createElement(Subtitle, null),
      React__default.createElement(DescriptionContainer, null),
      React__default.createElement(Primary, null),
      React__default.createElement(ArgsTable, {story: PRIMARY_STORY}),
      React__default.createElement(Stories, null)
    )
  },
  _templateObject$2
...
`,
  ...
  DocsContainer = function ee(_) {
    var te = _.context,
      ...
      pe = ue === void 0 ? {} : ue,
      de = pe.theme
    !de && ce.theme && (warnOptionsTheme(), (de = ce.theme))
    var me = ensure(de),
      se = Object.assign({}, defaultComponents, pe.components)
    return (
      react.exports.useEffect(
        function () {
          var he
...
var Preview = browser(
    function (ee) {
      return React__default.createElement(Canvas, ee)
    },
    dedent$2(
      _templateObject$1 ||
...
var Props = browser(
  function (ee) {
    return React__default.createElement(ArgsTable, ee)
  },
  dedent$2(
    _templateObject ||
...
export {
  ...
  commonjsGlobal as c,
  dedent as d,
  _objectWithoutPropertiesLoose$3 as e,
  _extends$2 as f,
  ...
  viewport as x,
  reference as y,
  clippingParents as z,
}
//# sourceMappingURL=index.3861d36b.js.map
