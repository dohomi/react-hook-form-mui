...
import {b as T, a as d, j as y, f as G} from './iframe.b13c84ce.js'
var X, q
function E(a, r, e) {
  return (
    r in a
          ...
          return [
            function (m) {
              ...
              if (
                ...
                p.focus(), o(mr(p, h, u.current)), O(!0)
              }
            },
            function (m) {
...
var ue =
  ...
  ce = function (r) {
    ...
    return G('div', {
      ...z({}, u, {ref: l, className: x}),
      children: [
        y(Pr, {hsva: v, onChange: f}),
        y(Fr, {
          hue: v.h,
          onChange: f,
  ...
  ve = function (r) {
    return T.createElement(ce, z({}, r, {colorModel: se}))
  },
  fe = function (r) {
    var e = r.className,
      n = r.hsva,
    ...
    return G('div', {
      className: i,
      children: [
        y('div', {className: 'react-colorful__alpha-gradient', style: o}),
        T.createElement(
          pr,
          {
            onMove: function (l) {
  ...
  he = {defaultColor: 'hsla(0, 0%, 0%, 1)', toHsva: te, fromHsva: Y, equal: zr},
  de = function (r) {
    return y($r, {...z({}, r, {colorModel: he})})
  },
  pe = {
  ...
  W = be,
  Xr = {}
for (var tr = 0, wr = Object.keys(W); tr < wr.length; tr++) {
  var kr = wr[tr]
  Xr[W[kr]] = kr
}
var s = {
...
for (var or = 0, Mr = Object.keys(s); or < Mr.length; or++) {
  ...
  delete s[I].channels,
    delete s[I].labels,
    Object.defineProperty(s[I], 'channels', {value: me}),
    Object.defineProperty(s[I], 'labels', {value: ye})
}
...
function Ye(a, r, e) {
  ...
  ;(r = _r(r) || 0),
    De(e) &&
      ((v = !!e.leading),
      (f = 'maxWait' in e),
      (o = f ? Je(_r(e.maxWait) || 0, r) : o),
      (x = 'trailing' in e ? !!e.trailing : x))
  function k(w) {
    var N = n,
      F = t
    return (n = t = void 0), (c = w), (i = a.apply(F, N)), i
  }
  function C(w) {
    return (c = w), (u = setTimeout(h, r)), v ? k(w) : i
  }
  function O(w) {
    var N = w - l,
      F = w - c,
  ...
  function p(w) {
    return (u = void 0), x && n ? k(w) : ((n = t = void 0), i)
  }
  function g() {
...
var J = Object.values(b),
    ...
    if (!!r) {
      ...
      if (pa.test(r)) {
        ...
        return (
          ...
          E(t, b.HEX, '#'.concat(R.rgb.hex([u, l, c]).toLowerCase())),
          t
        )
      }
      if (ga.test(r)) {
        ...
        return (
          ...
          E(m, b.HSL, r),
          E(m, b.HEX, '#'.concat(R.hsl.hex([g, M, S]).toLowerCase())),
          m
        )
      }
      var U = r.replace('#', ''),
        $ = R.keyword.rgb(U) || R.hex.rgb(U),
        er = R.rgb.hsl($),
        j = r
      if (
        (/[^#a-f0-9]/i.test(r) ? (j = U) : fr.test(r) && (j = '#'.concat(U)),
        j.startsWith('#'))
      )
        n = fr.test(j)
      else
  ...
  ya = function (r, e, n) {
    if (!r || !(e != null && e.valid)) return Q[n]
    if (n !== b.HEX) return (e == null ? void 0 : e[n]) || Q[n]
    if (!e.hex.startsWith('#'))
      try {
        return '#'.concat(R.keyword.hex(e.hex))
      } catch {
        return Q.hex
      }
    var t = e.hex.match(ba)
    if (!t) return fr.test(e.hex) ? e.hex : Q.hex
    var o = t[1].split(''),
      i = H(o, 3),
      u = i[0],
      l = i[1],
  ...
  xa = function (r, e) {
    ...
    var O = d.exports.useMemo(
      ...
      h = d.exports.useCallback(
        function () {
          var p = J.indexOf(k) + 1
          p >= J.length && (p = 0), C(J[p])
          var g = (c == null ? void 0 : c[J[p]]) || ''
          i(g), e(g)
        },
        [c, k, e]
      )
        ...
        function () {
          var v = (r || []).map(function (f) {
            return typeof f == 'string'
              ? V(f)
              : f.title
              ? Object.assign(Object.assign({}, V(f.color)), {keyword: f.title})
              : V(f.color)
          })
    ...
    return G(oa, {
      children: [
        y(ia, {
                ...
                y(ca, {
                  children: h.map(function (M, S) {
                    return y(
                      ...
                      {
                        hasChrome: !1,
                        tooltip: y(la, {note: M.keyword || M.value}),
                        children: y(Or, {
                          value: M[C],
          ...
          children: y(Or, {value: f, style: {margin: 4}}),
        }),
        y(fa, {
          id: Dr(e),
          value: v,
          onChange: function (S) {
            return x(S.target.value)
          },
          onFocus: function (S) {
        ...
        v ? y(ha, {icon: 'markup', onClick: O}) : null,
      ],
    })
  }
export {Sa as ColorControl, Sa as default}
//# sourceMappingURL=Color-3c22bb81.988f4e8a.js.map
