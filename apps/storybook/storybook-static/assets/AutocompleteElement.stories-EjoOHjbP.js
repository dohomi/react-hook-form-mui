import{j as s}from"./jsx-runtime-BjG_zV1W.js";import{t as eo,q as to,v as ne,P as yt,w as pe,x as oo,y as ro,z as A,A as so,D as ao,F as Le,H as no,J as po,p as Oe,K as j,L as io,M as lo,T as co,N as $e,k as wt,r as Mt,R as uo,a as mo,B as ho}from"./chunk-D5ZWXAHU-dJp8butX.js";import{B as go}from"./Box-B3JL9Smy.js";import{r as n}from"./index-Ca8FO3x4.js";import{a as vt,u as fo,b as Rt}from"./createTheme-BZiKxHa3.js";import"./index-P1EKaRb4.js";import"./v4-CQkTLCs1.js";function bo(o){return eo("MuiTooltip",o)}const To=to("MuiTooltip",["popper","popperInteractive","popperArrow","popperClose","tooltip","tooltipArrow","touch","tooltipPlacementLeft","tooltipPlacementRight","tooltipPlacementTop","tooltipPlacementBottom","arrow"]),r=To;function So(o){return Math.round(o*1e5)/1e5}const xo=o=>{const{classes:e,disableInteractive:a,arrow:m,touch:R,placement:T}=o,ie={popper:["popper",!a&&"popperInteractive",m&&"popperArrow"],tooltip:["tooltip",m&&"tooltipArrow",R&&"touch",`tooltipPlacement${vt(T.split("-")[0])}`],arrow:["arrow"]};return lo(ie,bo,e)},yo=ne(yt,{name:"MuiTooltip",slot:"Popper",overridesResolver:(o,e)=>{const{ownerState:a}=o;return[e.popper,!a.disableInteractive&&e.popperInteractive,a.arrow&&e.popperArrow,!a.open&&e.popperClose]}})(pe(({theme:o})=>({zIndex:(o.vars||o).zIndex.tooltip,pointerEvents:"none",variants:[{props:({ownerState:e})=>!e.disableInteractive,style:{pointerEvents:"auto"}},{props:({open:e})=>!e,style:{pointerEvents:"none"}},{props:({ownerState:e})=>e.arrow,style:{[`&[data-popper-placement*="bottom"] .${r.arrow}`]:{top:0,marginTop:"-0.71em","&::before":{transformOrigin:"0 100%"}},[`&[data-popper-placement*="top"] .${r.arrow}`]:{bottom:0,marginBottom:"-0.71em","&::before":{transformOrigin:"100% 0"}},[`&[data-popper-placement*="right"] .${r.arrow}`]:{height:"1em",width:"0.71em","&::before":{transformOrigin:"100% 100%"}},[`&[data-popper-placement*="left"] .${r.arrow}`]:{height:"1em",width:"0.71em","&::before":{transformOrigin:"0 0"}}}},{props:({ownerState:e})=>e.arrow&&!e.isRtl,style:{[`&[data-popper-placement*="right"] .${r.arrow}`]:{left:0,marginLeft:"-0.71em"}}},{props:({ownerState:e})=>e.arrow&&!!e.isRtl,style:{[`&[data-popper-placement*="right"] .${r.arrow}`]:{right:0,marginRight:"-0.71em"}}},{props:({ownerState:e})=>e.arrow&&!e.isRtl,style:{[`&[data-popper-placement*="left"] .${r.arrow}`]:{right:0,marginRight:"-0.71em"}}},{props:({ownerState:e})=>e.arrow&&!!e.isRtl,style:{[`&[data-popper-placement*="left"] .${r.arrow}`]:{left:0,marginLeft:"-0.71em"}}}]}))),wo=ne("div",{name:"MuiTooltip",slot:"Tooltip",overridesResolver:(o,e)=>{const{ownerState:a}=o;return[e.tooltip,a.touch&&e.touch,a.arrow&&e.tooltipArrow,e[`tooltipPlacement${vt(a.placement.split("-")[0])}`]]}})(pe(({theme:o})=>({backgroundColor:o.vars?o.vars.palette.Tooltip.bg:Rt(o.palette.grey[700],.92),borderRadius:(o.vars||o).shape.borderRadius,color:(o.vars||o).palette.common.white,fontFamily:o.typography.fontFamily,padding:"4px 8px",fontSize:o.typography.pxToRem(11),maxWidth:300,margin:2,wordWrap:"break-word",fontWeight:o.typography.fontWeightMedium,[`.${r.popper}[data-popper-placement*="left"] &`]:{transformOrigin:"right center"},[`.${r.popper}[data-popper-placement*="right"] &`]:{transformOrigin:"left center"},[`.${r.popper}[data-popper-placement*="top"] &`]:{transformOrigin:"center bottom",marginBottom:"14px"},[`.${r.popper}[data-popper-placement*="bottom"] &`]:{transformOrigin:"center top",marginTop:"14px"},variants:[{props:({ownerState:e})=>e.arrow,style:{position:"relative",margin:0}},{props:({ownerState:e})=>e.touch,style:{padding:"8px 16px",fontSize:o.typography.pxToRem(14),lineHeight:`${So(16/14)}em`,fontWeight:o.typography.fontWeightRegular}},{props:({ownerState:e})=>!e.isRtl,style:{[`.${r.popper}[data-popper-placement*="left"] &`]:{marginRight:"14px"},[`.${r.popper}[data-popper-placement*="right"] &`]:{marginLeft:"14px"}}},{props:({ownerState:e})=>!e.isRtl&&e.touch,style:{[`.${r.popper}[data-popper-placement*="left"] &`]:{marginRight:"24px"},[`.${r.popper}[data-popper-placement*="right"] &`]:{marginLeft:"24px"}}},{props:({ownerState:e})=>!!e.isRtl,style:{[`.${r.popper}[data-popper-placement*="left"] &`]:{marginLeft:"14px"},[`.${r.popper}[data-popper-placement*="right"] &`]:{marginRight:"14px"}}},{props:({ownerState:e})=>!!e.isRtl&&e.touch,style:{[`.${r.popper}[data-popper-placement*="left"] &`]:{marginLeft:"24px"},[`.${r.popper}[data-popper-placement*="right"] &`]:{marginRight:"24px"}}},{props:({ownerState:e})=>e.touch,style:{[`.${r.popper}[data-popper-placement*="top"] &`]:{marginBottom:"24px"}}},{props:({ownerState:e})=>e.touch,style:{[`.${r.popper}[data-popper-placement*="bottom"] &`]:{marginTop:"24px"}}}]}))),Mo=ne("span",{name:"MuiTooltip",slot:"Arrow",overridesResolver:(o,e)=>e.arrow})(pe(({theme:o})=>({overflow:"hidden",position:"absolute",width:"1em",height:"0.71em",boxSizing:"border-box",color:o.vars?o.vars.palette.Tooltip.bg:Rt(o.palette.grey[700],.9),"&::before":{content:'""',margin:"auto",display:"block",width:"100%",height:"100%",backgroundColor:"currentColor",transform:"rotate(45deg)"}})));let W=!1;const ke=new co;let M={x:0,y:0};function B(o,e){return(a,...m)=>{e&&e(a,...m),o(a,...m)}}const vo=n.forwardRef(function(e,a){const m=oo({props:e,name:"MuiTooltip"}),{arrow:R=!1,children:T,classes:ie,components:C={},componentsProps:I={},describeChild:Ct=!1,disableFocusListener:It=!1,disableHoverListener:le=!1,disableInteractive:Pt=!1,disableTouchListener:Lt=!1,enterDelay:ce=100,enterNextDelay:ue=0,enterTouchDelay:Ot=700,followCursor:Y=!1,id:$t,leaveDelay:me=0,leaveTouchDelay:kt=1500,onClose:de,onOpen:he,open:Et,placement:ge="bottom",PopperComponent:fe,PopperProps:d={},slotProps:h={},slots:At={},title:b,TransitionComponent:jt,TransitionProps:Wt,...be}=m,g=n.isValidElement(T)?T:s.jsx("span",{children:T}),Te=ro(),Bt=fo(),[S,Se]=n.useState(),[Q,Ft]=n.useState(null),P=n.useRef(!1),Z=Pt||Y,xe=A(),ee=A(),L=A(),ye=A(),[qt,we]=so({controlled:Et,default:!1,name:"Tooltip",state:"open"});let u=qt;const te=ao($t),x=n.useRef(),O=Le(()=>{x.current!==void 0&&(document.body.style.WebkitUserSelect=x.current,x.current=void 0),ye.clear()});n.useEffect(()=>O,[O]);const Me=t=>{ke.clear(),W=!0,we(!0),he&&!u&&he(t)},$=Le(t=>{ke.start(800+me,()=>{W=!1}),we(!1),de&&u&&de(t),xe.start(Te.transitions.duration.shortest,()=>{P.current=!1})}),k=t=>{P.current&&t.type!=="touchstart"||(S&&S.removeAttribute("title"),ee.clear(),L.clear(),ce||W&&ue?ee.start(W?ue:ce,()=>{Me(t)}):Me(t))},oe=t=>{ee.clear(),L.start(me,()=>{$(t)})},[,ve]=n.useState(!1),Re=t=>{$e(t.target)||(ve(!1),oe(t))},Ce=t=>{S||Se(t.currentTarget),$e(t.target)&&(ve(!0),k(t))},Ie=t=>{P.current=!0;const c=g.props;c.onTouchStart&&c.onTouchStart(t)},Dt=t=>{Ie(t),L.clear(),xe.clear(),O(),x.current=document.body.style.WebkitUserSelect,document.body.style.WebkitUserSelect="none",ye.start(Ot,()=>{document.body.style.WebkitUserSelect=x.current,k(t)})},Nt=t=>{g.props.onTouchEnd&&g.props.onTouchEnd(t),O(),L.start(kt,()=>{$(t)})};n.useEffect(()=>{if(!u)return;function t(c){c.key==="Escape"&&$(c)}return document.addEventListener("keydown",t),()=>{document.removeEventListener("keydown",t)}},[$,u]);const zt=no(po(g),Se,a);!b&&b!==0&&(u=!1);const re=n.useRef(),Ut=t=>{const c=g.props;c.onMouseMove&&c.onMouseMove(t),M={x:t.clientX,y:t.clientY},re.current&&re.current.update()},y={},se=typeof b=="string";Ct?(y.title=!u&&se&&!le?b:null,y["aria-describedby"]=u?te:null):(y["aria-label"]=se?b:null,y["aria-labelledby"]=u&&!se?te:null);const i={...y,...be,...g.props,className:Oe(be.className,g.props.className),onTouchStart:Ie,ref:zt,...Y?{onMouseMove:Ut}:{}},w={};Lt||(i.onTouchStart=Dt,i.onTouchEnd=Nt),le||(i.onMouseOver=B(k,i.onMouseOver),i.onMouseLeave=B(oe,i.onMouseLeave),Z||(w.onMouseOver=k,w.onMouseLeave=oe)),It||(i.onFocus=B(Ce,i.onFocus),i.onBlur=B(Re,i.onBlur),Z||(w.onFocus=Ce,w.onBlur=Re));const f={...m,isRtl:Bt,arrow:R,disableInteractive:Z,placement:ge,PopperComponentProp:fe,touch:P.current},l=typeof h.popper=="function"?h.popper(f):h.popper,Ht=n.useMemo(()=>{var c,Pe;let t=[{name:"arrow",enabled:!!Q,options:{element:Q,padding:4}}];return(c=d.popperOptions)!=null&&c.modifiers&&(t=t.concat(d.popperOptions.modifiers)),(Pe=l==null?void 0:l.popperOptions)!=null&&Pe.modifiers&&(t=t.concat(l.popperOptions.modifiers)),{...d.popperOptions,...l==null?void 0:l.popperOptions,modifiers:t}},[Q,d.popperOptions,l==null?void 0:l.popperOptions]),ae=xo(f),Vt=typeof h.transition=="function"?h.transition(f):h.transition,E={slots:{popper:C.Popper,transition:C.Transition??jt,tooltip:C.Tooltip,arrow:C.Arrow,...At},slotProps:{arrow:h.arrow??I.arrow,popper:{...d,...l??I.popper},tooltip:h.tooltip??I.tooltip,transition:{...Wt,...Vt??I.transition}}},[_t,Kt]=j("popper",{elementType:yo,externalForwardedProps:E,ownerState:f,className:Oe(ae.popper,d==null?void 0:d.className)}),[Gt,Jt]=j("transition",{elementType:io,externalForwardedProps:E,ownerState:f}),[Xt,Yt]=j("tooltip",{elementType:wo,className:ae.tooltip,externalForwardedProps:E,ownerState:f}),[Qt,Zt]=j("arrow",{elementType:Mo,className:ae.arrow,externalForwardedProps:E,ownerState:f,ref:Ft});return s.jsxs(n.Fragment,{children:[n.cloneElement(g,i),s.jsx(_t,{as:fe??yt,placement:ge,anchorEl:Y?{getBoundingClientRect:()=>({top:M.y,left:M.x,right:M.x,bottom:M.y,width:0,height:0})}:S,popperRef:re,open:S?u:!1,id:te,transition:!0,...w,...Kt,popperOptions:Ht,children:({TransitionProps:t})=>s.jsx(Gt,{timeout:Te.transitions.duration.shorter,...t,...Jt,children:s.jsxs(Xt,{...Yt,children:[b,R?s.jsx(Qt,{...Zt}):null]})})})]})}),Ro=wt(s.jsx("path",{d:"M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7m0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5"})),Co=wt([s.jsx("path",{d:"M19.03 3.56c-1.67-1.39-3.74-2.3-6.03-2.51v2.01c1.73.19 3.31.88 4.61 1.92zM11 3.06V1.05c-2.29.2-4.36 1.12-6.03 2.51l1.42 1.42C7.69 3.94 9.27 3.25 11 3.06M4.98 6.39 3.56 4.97C2.17 6.64 1.26 8.71 1.05 11h2.01c.19-1.73.88-3.31 1.92-4.61M20.94 11h2.01c-.21-2.29-1.12-4.36-2.51-6.03l-1.42 1.42c1.04 1.3 1.73 2.88 1.92 4.61M7 12l3.44 1.56L12 17l1.56-3.44L17 12l-3.44-1.56L12 7l-1.56 3.44z"},"0"),s.jsx("path",{d:"M12 21c-3.11 0-5.85-1.59-7.46-4H7v-2H1v6h2v-2.7c1.99 2.84 5.27 4.7 9 4.7 4.87 0 9-3.17 10.44-7.56l-1.96-.45C19.25 18.48 15.92 21 12 21"},"1")]),jo={title:"Select/Autocomplete",component:Mt,decorators:[Io]};function Io(o){return s.jsxs(uo,{onSuccess:mo("form-submit"),defaultValues:{preselect:{id:2,label:"Second"},"multi-preselect":[{id:2,label:"Second"}],"match-id":2,"match-id-multi":[2,3]},children:[s.jsx(o,{}),s.jsx(go,{marginTop:2,children:s.jsx(ho,{type:"submit",children:"Submit"})})]})}const p=[{label:"First",id:1},{label:"Second",id:2},{label:"Third",id:3},{label:"Four",id:4}],F={args:{name:"basic",options:p}},q={args:{name:"basic",options:p,autocompleteProps:{disabled:!0}}},D={args:{name:"preselect",options:p}},N={args:{name:"multi",options:p,multiple:!0}},z={args:{label:"Multiple Required",name:"multi-required",options:p,multiple:!0,required:!0}},U={args:{label:"Multiple Required Custom",name:"multi-required-custom",options:p,multiple:!0,rules:{required:"Please fill out."}}},H={args:{name:"multi-preselect",options:p,multiple:!0}},V={args:{name:"multicheck",options:p,multiple:!0,showCheckbox:!0}},_={args:{label:"Loading State",name:"loading",options:[],multiple:!0,showCheckbox:!0,loading:!0}},K={args:{label:"Loading State",name:"loading",options:[],multiple:!0,showCheckbox:!0,loading:!0,loadingIndicator:s.jsx(Co,{})}},G={args:{label:"Match ID",name:"match-id",options:p,matchId:!0}},J={args:{label:"Match ID",name:"match-id-multi",options:p,multiple:!0,matchId:!0}},X={args:{name:"custom-input",options:p,textFieldProps:{placeholder:"Some placeholder",InputProps:{startAdornment:s.jsx(Ro,{}),endAdornment:null}}}},v=()=>s.jsx(vo,{title:"Some Tooltip",children:s.jsx("div",{children:s.jsx(Mt,{options:p,name:"tooltip",label:"With Tooltip"})})});v.__docgenInfo={description:"",methods:[],displayName:"WithTooltip"};var Ee,Ae,je;F.parameters={...F.parameters,docs:{...(Ee=F.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    name: 'basic',
    options
  }
...
}`,...(ot=(tt=V.parameters)==null?void 0:tt.docs)==null?void 0:ot.source}}};var rt,st,at;_.parameters={..._.parameters,docs:{...(rt=_.parameters)==null?void 0:rt.docs,source:{originalSource:`{
  args: {
    label: 'Loading State',
    name: 'loading',
    options: [],
...
}`,...(at=(st=_.parameters)==null?void 0:st.docs)==null?void 0:at.source}}};var nt,pt,it;K.parameters={...K.parameters,docs:{...(nt=K.parameters)==null?void 0:nt.docs,source:{originalSource:`{
  args: {
    label: 'Loading State',
    name: 'loading',
    options: [],
