import {s as Wn} from './index-d475d2ea.js'
import {R as Le, r as Ie, g as Pt, c as lt, a as $n} from './index-ebeaab24.js'
import {
  u as Ur,
  r as Jn,
  a as Xn,
...
import {P as $r} from './index-aff217c3.js'
import {d as ns} from './index-356e4a49.js'
import './index-9c09ad76.js'
var {FRAMEWORK_OPTIONS: Yt} = Wn,
  Tu = (e, t) => {
  ...
  Jr = Yt != null && Yt.strictMode ? Ie.StrictMode : Ie.Fragment
async function Iu(
  {
    storyContext: e,
    unboundStoryFn: t,
  ...
  let c = Le.createElement(
    ...
    f = Jr ? Le.createElement(Jr, null, c) : c
  return s && Ur(a), await Jn(f, a), () => Ur(a)
}
const as = [
  'a',
  'abbr',
              ...
              if (((we = ue[H]), (ie = R[we]), !!ie))
                if (Array.isArray(ie)) {
                  for (ne = ie.length; (ne -= 1) >= 0; )
                    if (ie[ne]) {
                      if (v(G, ue[H]))
                        D = new E(ie[ne], [we, ne], 'Property', new b(ie, ne))
                      else if (C(ie[ne]))
                        D = new E(ie[ne], [we, ne], null, new b(ie, ne))
                      else continue
                      k.push(D)
                    }
...
function ms() {
  return (
    ni ||
      ((ni = 1),
      (nt.SourceMapGenerator = Ti().SourceMapGenerator),
      (nt.SourceMapConsumer = ps().SourceMapConsumer),
      (nt.SourceNode = ds().SourceNode)),
    nt
  )
}
const gs = 'escodegen',
  ys = 'ECMAScript code generator',
  vs = 'http://github.com/estools/escodegen',
  xs = 'escodegen.js',
  bs = {esgenerate: './bin/esgenerate.js', escodegen: './bin/escodegen.js'},
  Ss = ['LICENSE.BSD', 'README.md', 'bin', 'escodegen.js', 'package.json'],
  _s = '2.0.0',
  Es = {node: '>=6.0'},
  Cs = [
    {
  ...
  As = {type: 'git', url: 'http://github.com/estools/escodegen.git'},
  ws = {
    estraverse: '^5.2.0',
    esutils: '^2.0.2',
    esprima: '^4.0.1',
...
`,
    ...
    function xt(n, u) {
      ...
      for (o in u)
        u.hasOwnProperty(o) &&
          ((l = u[o]),
          d(l) ? (d(n[o]) ? xt(n[o], l) : (n[o] = xt({}, l))) : (n[o] = l))
      return n
    }
    function Rn(n) {
      var u, o, l, d, w
    ...
    function qn(n, u) {
      ...
      for (
        ...
        (J = Z(pe(o[l].slice(P)))), (o[l] = x ? J.join('') : J)
      return (
        (f = F),
        o.join(`
`)
...
`),
    ...
    function Br(n, u) {
      var o, l, d, w, T, P, F, J, ce, Ue, Xe, jr, qr, ke
        ...
        return (
          ...
          n.expression
            ? (u.push(v),
              ...
              u.push(o))
            : u.push(this.maybeBlock(n.body, Ln)),
          u
        )
      }),
            ...
            u.left.type === t.VariableDeclaration
              ? ae(function () {
                  l.push(u.left.kind + fe()),
                    l.push(d.generateStatement(u.left.declarations[0], vt))
                })
...
` && (d = ['{']),
              ...
              var T, P, F, J
              for (
                J = K, u & ue && (J |= ie), T = 0, P = n.body.length;
                T < P;
                ++T
              )
                k &&
...
` && (d = ['{'])),
                    n.body[0].leadingComments ||
                      Je(n.range[0], n.body[0].range[0], d)),
                  T > 0 &&
                  ...
                  k &&
                    ...
                    (n.body[T].trailingComments ||
                      Je(n.body[T].range[1], n.range[1], d))
            }),
            d.push(pe('}')),
            d
          )
        ...
        DirectiveStatement: function (n, u) {
          return A.raw && n.raw
            ...
            : Dn(n.directive) + this.semicolon(u)
        },
...
`),
        ...
        TryStatement: function (n, u) {
          ...
          return (
            n.finalizer &&
              (o = U(o, ['finally', this.maybeBlock(n.finalizer, K)])),
            o
          )
        },
              ...
              for (
                n.test
                  ...
                  w &&
                    ...
                    ((l = P.maybeBlock(n.consequent[0], K)),
                    o.push(l),
                    (d = 1)),
              ...
              ;(o = ['for' + v + '(']),
                n.init
                  ? n.init.type === t.VariableDeclaration
                    ? o.push(l.generateStatement(n.init, vt))
                    : (o.push(l.generateExpression(n.init, r.Sequence, be)),
                      o.push(';'))
                  : o.push(';'),
                n.test &&
                  (o.push(v),
...
`
            ...
            !L && d === w - 1 && (T |= Q),
              k &&
                (d === 0 &&
                  (n.body[0].leadingComments ||
                    Je(n.range[0], n.body[d].range[0], o)),
                d > 0 &&
              ...
              k &&
                ...
                (n.body[d].trailingComments ||
                  Je(n.body[d].range[1], n.range[1], o))
          return o
        },
      ...
      (oe.Expression = {
        ...
        ObjectPattern: function (n, u, o) {
          ...
          if (((T = !1), n.properties.length === 1))
            (P = n.properties[0]),
              P.type === t.Property && P.value.type !== t.Identifier && (T = !0)
          else
          ...
          return (
            n.left.type === t.VariableDeclaration
              ? (l = [
                  n.left.kind,
                  fe(),
                  this.generateStatement(n.left.declarations[0], vt),
                ])
...
` &&
    ...
    function zn(n, u) {
      ...
      return (
        ...
        (A = u),
        x &&
          (e.browser ? (s = lt.sourceMap.SourceNode) : (s = ms().SourceNode)),
        (l = Gn(n)),
        x
...
function Re(e, t) {
  return e < 65
    ...
    ? !0
    : e <= 65535
    ? e >= 170 && Rs.test(String.fromCharCode(e))
    : t === !1
    ? !1
    : ur(e, Pi)
}
function ze(e, t) {
  return e < 48
    ...
    ? !0
    : e <= 65535
    ? e >= 170 && Fs.test(String.fromCharCode(e))
    : t === !1
    ? !1
    : ur(e, Pi) || ur(e, Ms)
}
...
function Vs(e) {
  var t = {}
  for (var r in At) t[r] = e && Lt(e, r) ? e[r] : At[r]
  if (
  ...
  return si(t.onComment) && (t.onComment = js(t, t.onComment)), t
}
function js(e, t) {
...
var ai = 0,
  ...
  re = function (t, r, i) {
    ;(this.options = t = Vs(t)),
      ...
      (this.keywords = Ge(
        Ls[t.ecmaVersion >= 6 ? 6 : t.sourceType === 'module' ? '5module' : 5]
      ))
    var s = ''
...
Object.defineProperties(re.prototype, We)
var me = re.prototype,
  qs = /^(?:'((?:\\.|[^'\\])*?)'|"((?:\\.|[^"\\])*?)")/
...
z.isLet = function (e) {
  ...
  if (i === 123) return !0
  if (Re(i, !0)) {
    for (var s = r + 1; ze(this.input.charCodeAt(s), !0); ) ++s
    var a = this.input.slice(r, s)
    if (!Os.test(a)) return !0
  }
  return !1
}
z.isAsyncFunction = function () {
  ...
  return (
    ...
    (t + 8 === this.input.length || !ze(this.input.charAt(t + 8)))
  )
}
...
z.parseTryStatement = function (e) {
  if (
    ...
    if ((this.next(), this.eat(h.parenL))) {
      ...
      this.enterScope(r ? Fi : 0),
        this.checkLVal(t.param, r ? Vi : Oe),
...
z.parseVarId = function (e, t) {
  ;(e.id = this.parseBindingAtom()),
    this.checkLVal(e.id, t === 'var' ? Sr : Oe, !1)
}
var ot = 1,
  lr = 2,
  qi = 4
z.parseFunction = function (e, t, r, i) {
  this.initFunction(e),
    ...
    t & ot &&
      ((e.id = t & qi && this.type !== h.name ? null : this.parseIdent()),
      e.id &&
        !(t & lr) &&
        this.checkLVal(
          e.id,
...
z.parseExport = function (e, t) {
  ...
  if (this.eat(h._default)) {
    ...
    if (this.type === h._function || (r = this.isAsyncFunction())) {
      ...
      this.next(),
        r && this.next(),
        (e.declaration = this.parseFunction(i, ot | qi, !1, r))
...
z.checkExport = function (e, t, r) {
  e &&
    (Lt(e, t) && this.raiseRecoverable(r, "Duplicate export '" + t + "'"),
    (e[t] = !0))
}
...
z.parseImport = function (e) {
  return (
    this.next(),
    this.type === h.string
      ? ((e.specifiers = Gs), (e.source = this.parseExprAtom()))
    ...
    case 'Identifier':
      t === Oe &&
        ...
        r &&
          ...
          (r[e.name] = !0)),
        t !== ai && t !== ji && this.declareName(e.name, t, e.start)
      break
    case 'ChainExpression':
      this.raiseRecoverable(
        e.start,
...
W.parseMethod = function (e, t, r) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(br(t, i.generator) | Mi | (r ? Bi : 0)),
    this.expect(h.parenL),
...
Ve.declareName = function (e, t, r) {
  ...
  if (t === Oe) {
    ...
    for (var f = this.scopeStack.length - 1; f >= 0; --f) {
      ...
      if (
        (p.lexical.indexOf(e) > -1 && !(p.flags & Fi && p.lexical[0] === e)) ||
...
Ve.currentThisScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e]
    if (t.flags & xr && !(t.flags & Ri)) return t
  }
}
...
function Er(e) {
  var t = (Ji[e] = {
    binary: Ge(Js[e] + ' ' + oi),
    nonBinary: {General_Category: Ge(oi), Script: Ge(Hs[e])},
  })
  ...
  Me = function (t) {
    ;(this.parser = t),
      ...
      (this.unicodeProperties =
        Ji[t.options.ecmaVersion >= 11 ? 11 : t.options.ecmaVersion]),
      (this.source = ''),
      (this.flags = ''),
      (this.start = 0),
      (this.switchU = !1),
...
j.regexp_eatPatternCharacters = function (e) {
  for (var t = e.pos, r = 0; (r = e.current()) !== -1 && !Xi(r); ) e.advance()
  return e.pos !== t
}
...
j.regexp_eatRegExpIdentifierStart = function (e) {
  ...
  return (
    ...
    i === 92 &&
      ...
      (i = e.lastIntValue),
    Qs(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  )
}
function Qs(e) {
...
j.regexp_eatRegExpIdentifierPart = function (e) {
  ...
  return (
    ...
    i === 92 &&
      this.regexp_eatRegExpUnicodeEscapeSequence(e, r) &&
      (i = e.lastIntValue),
    Ys(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  )
}
function Ys(e) {
  return ze(e, !0) || e === 36 || e === 95 || e === 8204 || e === 8205
}
...
j.regexp_eatZero = function (e) {
  return e.current() === 48 && !Bt(e.lookahead())
...
j.regexp_eatUnicodePropertyValue = function (e) {
  var t = 0
  for (e.lastStringValue = ''; ea((t = e.current())); )
    (e.lastStringValue += kt(t)), e.advance()
  return e.lastStringValue !== ''
}
function ea(e) {
...
j.regexp_eatClassAtom = function (e) {
  ...
  if (e.eat(92)) {
    ...
    if (e.switchU) {
      var r = e.current()
      ;(r === 99 || Zi(r)) && e.raise('Invalid class escape'),
        e.raise('Invalid escape')
    }
    e.pos = t
  }
...
j.regexp_eatHexDigits = function (e) {
  var t = e.pos,
    r = 0
  for (e.lastIntValue = 0; Yi((r = e.current())); )
...
$.readRegexp = function () {
  for (var e, t, r = this.pos; ; ) {
    ...
    if ((xe.test(i) && this.raise(r, 'Unterminated regular expression'), e))
      e = !1
    else {
      if (i === '[') t = !0
      else if (i === ']' && t) t = !1
...
$.readRadixNumber = function (e) {
  ...
  return (
    ...
    this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
      ? ((r = en(this.input.slice(t, this.pos))), ++this.pos)
...
$.readNumber = function (e) {
  ...
  if (!r && !e && this.options.ecmaVersion >= 11 && i === 110) {
    var s = en(this.input.slice(t, this.pos))
    return (
      ++this.pos,
      Re(this.fullCharCodeAtPos()) &&
        this.raise(this.pos, 'Identifier directly after number'),
  ...
  r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
    ...
    Re(this.fullCharCodeAtPos()) &&
      this.raise(this.pos, 'Identifier directly after number')
  var a = ta(this.input.slice(t, this.pos), r)
...
$.tryReadTemplateToken = function () {
  ...
  try {
    ...
    if (e === tn) this.readInvalidTemplateToken()
    else throw e
  }
...
$.readWord1 = function () {
  ...
  for (
    ...
    if (ze(s, i)) this.pos += s <= 65535 ? 1 : 2
    else if (s === 92) {
...
var ca = _i,
  ...
  ya = an.call(Object)
function va(e) {
  if (!fa(e) || ca(e) != pa) return !1
  var t = ha(e)
  if (t === null) return !0
  var r = ga.call(t, 'constructor') && t.constructor
...
var Sa = _i,
  ...
  Ca = '[object String]'
function Aa(e) {
  return typeof e == 'string' || (!_a(e) && Ea(e) && Sa(e) == Ca)
}
var wa = Aa
const ka = Pt(wa)
/*!
 ...
 */ var wr = Symbol.for('react.element'),
  ...
  Ra = Symbol.for('react.server_context'),
...
var cn = function (t) {
  ...
  $a = function (t) {
    switch (!0) {
      ...
      case typeof t.type == 'function':
        return t.type.displayName ? t.type.displayName : hn(t.type)
  ...
  Tr = function e(t, r) {
    var i = r.displayName,
      s = i === void 0 ? $a : i
    if (typeof t == 'string') return cn(t)
    if (typeof t == 'number') return qa(t)
    ...
    return za && t.type === Ie.Fragment ? Ga(f, y) : Ua(a, c, p, y)
  }
function Xa() {}
var Ha = function (t) {
    return t
...
`.concat(Ne(r + 1, i.tabStop), '$1')
  ...
  Ka = function (t, r, i, s) {
    ...
    if (typeof t == 'string') return '"'.concat(Ya(t), '"')
    if (ht(t) === 'symbol') {
      var a = t
        .valueOf()
        .toString()
    ...
    return typeof t == 'function'
      ...
      : Ta(t) || Array.isArray(t)
      ? '{'.concat(Qa(t, r, i, s), '}')
      : '{'.concat(String(t), '}')
  },
  Za = function (e, t, r, i, s, a, c, f) {
    if (!t && !i)
      throw new Error(
        'The prop "'.concat(
          e,
  ...
  eo = function (e, t) {
    ...
    return (
      ...
      (i.type === 'string' || i.type === 'number')
        ? r.push(cn(String(i.value) + String(t.value)))
        : (i && r.push(i), r.push(t)),
      r
    )
  },
...
`)
  ...
  oo = function (t, r, i, s, a, c, f) {
    return (pn(t, r, a, c, f) || i) && !s
  },
  dn = function (e, t, r, i) {
    var s = e.type,
      a = e.displayName,
...
`),
  ...
  fo = function (e, t, r, i) {
    ...
    var f = i.useFragmentShortSyntax,
      p
    return (
      f ? (ho(e) || co(e) ? (p = di) : (p = uo)) : (p = di),
      dn(lo(p, a, c), t, r, i)
    )
  },
  po = ['<', '>', '{', '}'],
  mo = function (t) {
    return po.some(function (r) {
      return t.includes(r)
    })
  },
  go = function (t) {
    return mo(t) ? '{`'.concat(t, '`}') : t
  },
  yo = function (t) {
    var r = t
    return (
  ...
  Ht = function (e, t, r, i) {
    ...
    if (e.type === 'string')
      return e.value ? ''.concat(yo(go(String(e.value)))) : ''
    if (e.type === 'ReactElement') return dn(e, t, r, i)
    if (e.type === 'ReactFragment') return fo(e, t, r, i)
...
var fr = 'custom',
  ...
  et = 'element'
function Pr(e) {
  return us.includes(e.toLowerCase())
}
var mn = {format: {indent: {style: '  '}, semicolons: !1}},
  wo = {...mn, format: {newline: ''}},
  ko = {...mn}
function Be(e, t = !1) {
  return Ci.generate(e, t ? wo : ko)
}
function pr(e, t = !1) {
  return t ? To(e) : Be(e)
}
...
function Io(e) {
  let t = Be(e)
  return t.endsWith('  }]') && (t = ns(t)), t
}
function Po(e) {
  let t = Be(e, !0)
  return t.startsWith('[    ') && (t = t.replace('[    ', '[')), t
}
var gn = (e) => e.$$typeof === Symbol.for('react.memo'),
  No = (e) => e.$$typeof === Symbol.for('react.forward_ref'),
  Nr = {...N, JSXElement: () => {}},
  Lo = re.extend(ua())
function yt(e) {
...
function Do(e) {
  ...
  return yt(t) === 'shape' ? vn(e.arguments[0]) : null
}
function vn(e) {
  return {inferredType: {type: 'Object', depth: yn(e)}, ast: e}
}
function Vo(e) {
  return {inferredType: {type: 'Array', depth: yn(e)}, ast: e}
}
function jo(e) {
  switch (e.type) {
    case 'Identifier':
...
function bn(e, t) {
  ...
  switch (s) {
    ...
    case 'Object': {
      let {depth: p} = r
      ;(a = gt), (c = p === 1 ? It(i, !0) : null), (f = It(i))
      break
    }
    case 'Element': {
      let {identifier: p} = r
      ;(a = p != null && !Pr(p) ? p : et),
        (c = yi(e).length === 1 ? e : null),
        (f = e)
      break
    }
    case 'Array': {
      let {depth: p} = r
      ;(a = Ir), (c = p <= 2 ? vi(i, !0) : null), (f = vi(i))
      break
    }
    default:
      ;(a = Go(s)), (c = yi(e).length === 1 ? e : null), (f = e)
      break
  }
...
function Wo(e) {
  ...
  return t != null && (t.params != null || t.returns != null)
    ? de({
        name: 'func',
        short: Eo(t.params, t.returns),
        compact: null,
        full: _o(t.params, t.returns),
      })
...
function Ho({value: e, computed: t}) {
  return t ? bn(e, 'enumvalue') : de({name: 'enumvalue', short: e, compact: e})
}
function Qo(e) {
  if (Array.isArray(e.value)) {
    let t = e.value.reduce(
      (r, i) => {
        let {short: s, compact: a, full: c} = Ho(i)
    ...
    switch (t.name) {
      ...
      case 'func': {
        let {short: r, full: i} = Ke(t, e),
          s = r,
          a
        return i && i.length < Uo ? (s = i) : i && (a = Co(i)), te(s, a)
      }
      default:
        return null
    }
...
function Sn({inferredType: e, ast: t}) {
  let {depth: r} = e
  if (r === 1) {
    let i = pr(t, !0)
    if (!ft(i)) return te(i)
...
function Zo({inferredType: e, ast: t}) {
  let {identifier: r} = e
  if (r != null) return te(En(e), Be(t))
  let i = Be(t, !0)
...
var iu = (e) => {
    if (An(e) && e.type != null) return ru(e)
    if (ba(e)) {
  ...
  su = (e) => te(e.toString()),
  kn = {string: tu, object: iu, function: nu, default: su}
function au(e = {}) {
  return {...kn, ...e}
}
function Tn(e, t, r = kn) {
  try {
    switch (typeof e) {
      case 'string':
        return r.string(e, t)
...
function hu(e, t) {
  let r = t.defaultProps != null ? t.defaultProps : {},
    i = e.map((s) => cu(s, r[s.propDef.name]))
  return ou(i, t)
}
function fu(e, t) {
  let {propDef: r} = e,
...
function du(e, t) {
  let r = e
  !ts(e) && !e.propTypes && gn(e) && (r = e.type)
  let i = rs(r, t)
...
var yu = (e, t) => {
    if (typeof e > 'u')
      return Et.warn('Too many skip or undefined component'), null
    let r = e,
      i = r.type
    for (let a = 0; a < t.skip; a += 1) {
      if (typeof r > 'u') return Et.warn('Cannot skip undefined element'), null
      if (Le.Children.count(r) > 1)
        return Et.warn('Trying to skip an array of elements'), null
      ...
      ...(typeof t.displayName == 'string'
        ...
        : {
            displayName: (a) =>
              ...
              (No(a.type) ? a.type.render.name : null) ||
              (gn(a.type) ? a.type.type.name : null) ||
              a.type,
          }),
...
`
  ...
  vu = {skip: 0, showFunctions: !1, enableBeautify: !0, showDefaultProps: !1},
  xu = (e) => {
    var i
    let t =
  ...
  Pn = (e, t) => {
    ...
    let a = e()
    if (i) return a
    let c = {...vu, ...((t == null ? void 0 : t.parameters.jsx) || {})},
      f =
        (b =
  ...
  Nu = [Yn],
  Lu = (e, t) => {
    let r = t.findIndex((s) => s.originalFn === Pn),
      i = r === -1 ? t : [...t.splice(r, 1), ...t]
    return xo(e, i)
  },
  Ou = {renderer: 'react', ...Su}
export {
  Lu as applyDecorators,
  Nu as argTypesEnhancers,
  Pu as decorators,
  Ou as parameters,
  Tu as render,
  Iu as renderToCanvas,
}
//# sourceMappingURL=config-49664eb8.js.map
