import {R as Le, r as Te, g as Nt, c as lt, b as $n} from './index-f1f2c4b1.js'
import {
  u as Gr,
  r as Jn,
  b as Xn,
...
import {P as Jr} from './index-d6b32626.js'
import {d as ns} from './index-356e4a49.js'
import './index-c74c9f7f.js'
const {global: ss} = __STORYBOOK_MODULE_GLOBAL__
var {FRAMEWORK_OPTIONS: Kt} = ss,
  Tu = (e, t) => {
...
async function Iu(
  ...
  return s && Gr(a), await Jn(f, a), () => Gr(a)
}
const os = [
  'a',
  'abbr',
...
function gs() {
  return (
    si ||
      ((si = 1),
      (nt.SourceMapGenerator = Ii().SourceMapGenerator),
      (nt.SourceMapConsumer = ds().SourceMapConsumer),
      (nt.SourceNode = ms().SourceNode)),
    nt
  )
}
const ys = 'escodegen',
  vs = 'ECMAScript code generator',
  xs = 'http://github.com/estools/escodegen',
  bs = 'escodegen.js',
  Ss = {esgenerate: './bin/esgenerate.js', escodegen: './bin/escodegen.js'},
  _s = ['LICENSE.BSD', 'README.md', 'bin', 'escodegen.js', 'package.json'],
  Es = '2.1.0',
  Cs = {node: '>=6.0'},
  As = [
    {
  ...
  ws = {type: 'git', url: 'http://github.com/estools/escodegen.git'},
  ks = {estraverse: '^5.2.0', esutils: '^2.0.2', esprima: '^4.0.1'},
  Ts = {'source-map': '~0.6.1'},
  Is = {
    acorn: '^8.0.4',
    bluebird: '^3.4.7',
...
` &&
    ...
    function Wn(n, u) {
      ...
      return (
        ...
        (A = u),
        x &&
          (e.browser ? (s = lt.sourceMap.SourceNode) : (s = gs().SourceNode)),
        (l = zn(n)),
        x
...
function js(e) {
  ...
  return ai(t.onComment) && (t.onComment = qs(t, t.onComment)), t
}
function qs(e, t) {
...
var oi = 0,
  ...
  re = function (t, r, i) {
    ;(this.options = t = js(t)),
      ...
      (this.keywords = ze(
        Os[t.ecmaVersion >= 6 ? 6 : t.sourceType === 'module' ? '5module' : 5]
      ))
    var s = ''
...
me.strictDirective = function (e) {
  for (;;) {
    ...
    var t = Us.exec(this.input.slice(e))
    if (!t) return !1
  ...
  if (
    ...
    if ((this.next(), this.eat(h.parenL))) {
      ...
      this.enterScope(r ? Mi : 0),
        this.checkLVal(t.param, r ? ji : Oe),
...
z.parseImport = function (e) {
  return (
    this.next(),
    this.type === h.string
      ? ((e.specifiers = zs), (e.source = this.parseExprAtom()))
    ...
    case 'Identifier':
      t === Oe &&
        ...
        r &&
          ...
          (r[e.name] = !0)),
        t !== oi && t !== qi && this.declareName(e.name, t, e.start)
      break
    case 'ChainExpression':
      this.raiseRecoverable(
        e.start,
...
W.parseMethod = function (e, t, r) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(Sr(t, i.generator) | Bi | (r ? Di : 0)),
    this.expect(h.parenL),
...
je.currentThisScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e]
    if (t.flags & br && !(t.flags & Fi)) return t
  }
}
...
function Cr(e) {
  var t = (Xi[e] = {
    binary: ze(Xs[e] + ' ' + ui),
    nonBinary: {General_Category: ze(ui), Script: ze(Qs[e])},
  })
...
j.regexp_eatRegExpIdentifierPart = function (e) {
  ...
  return (
    ...
    i === 92 &&
      this.regexp_eatRegExpUnicodeEscapeSequence(e, r) &&
      (i = e.lastIntValue),
    Ks(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  )
}
function Ks(e) {
...
j.regexp_eatCharacterClassEscape = function (e) {
  var t = e.current()
  if (ea(t)) return (e.lastIntValue = -1), e.advance(), !0
...
j.regexp_eatUnicodePropertyValue = function (e) {
  var t = 0
  for (e.lastStringValue = ''; ta((t = e.current())); )
    (e.lastStringValue += Tt(t)), e.advance()
  return e.lastStringValue !== ''
}
function ta(e) {
...
$.readNumber = function (e) {
  ...
  r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
    ...
    Re(this.fullCharCodeAtPos()) &&
      this.raise(this.pos, 'Identifier directly after number')
  var a = ra(this.input.slice(t, this.pos), r)
...
var ha = Ei,
  ...
  va = on.call(Object)
function xa(e) {
  if (!pa(e) || ha(e) != da) return !1
  var t = fa(e)
  if (t === null) return !0
  var r = ya.call(t, 'constructor') && t.constructor
  return typeof r == 'function' && r instanceof r && on.call(r) == va
}
var ba = xa
const Sa = Nt(ba)
var _a = Ei,
...
var pr = 'custom',
  ...
  rt = 'element'
function Nr(e) {
  return ls.includes(e.toLowerCase())
}
var gn = {format: {indent: {style: '  '}, semicolons: !1}},
  ko = {...gn, format: {newline: ''}},
  To = {...gn}
function De(e, t = !1) {
  return Ai.generate(e, t ? ko : To)
}
function dr(e, t = !1) {
  return t ? Io(e) : De(e)
}
...
function Ko(e, t) {
  let {name: r, short: i, compact: s, full: a, inferredType: c} = et(e.value, t)
  if (r === 'custom') {
...
//# sourceMappingURL=config-e9252d70.js.map
