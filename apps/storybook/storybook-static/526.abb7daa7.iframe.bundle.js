                        ...
                        return {
                          ...
                          _cssProperty: function (name) {
                            ...
                            for (
                              ...
                              for (
                                currVendorWithoutDashes = cssPrefixes[
                                  i
                                ].replace(/-/g, ''),
                                  resultPossibilities = [
                                    name,
                                ...
                                if (
                                  elmStyle[resultPossibilities[v]] !==
                                  undefined2
                                ) {
                      ...
                      EASING =
                        ...
                        }),
                        {
                          ...
                          easeOutSine: function (x, t, b, c, d) {
                            return (
                              c *
                                _easingsMath.s((t / d) * (_easingsMath.p / 2)) +
                              b
                            )
                          },
                          ...
                          easeInOutBounce: function (x, t, b, c, d) {
                            return t < d / 2
                              ...
                              : 0.5 *
                                  this.easeOutBounce(x, 2 * t - d, 0, c, d) +
                                  0.5 * c +
                                  b
                          },
                        }),
                          ...
                          (FakejQuery[LEXICON.p] = {
                            ...
                            addClass: function (className) {
                              ...
                              if (className)
                                for (
                                  classes =
                                    className.match(_rnothtmlwhite) || [];
                                  (elem = this[i++]);
                            ...
                            eq: function (index) {
                              return FakejQuery(
                                this[
                                  index >= 0 ? index : this[LEXICON.l] + index
                                ]
                              )
                            },
                        ...
                        function OverlayScrollbarsInstance(
                                ...
                                if (
                                  ...
                                  if (
                                    (finalElement = possibleElementIsJQuery
                                      ? possibleElement
                                      : FRAMEWORK(possibleElement))[strLength] >
                                    0
                                  ) {
                                    ;(margin =
                                      marginType == TYPES_n ||
                              ...
                              (_base.getElements = function (elementName) {
                                var obj = {
                                  ...
                                  scrollbarHorizontal: {
                                    ...
                                    handle:
                                      _scrollbarHorizontalHandleElement[0],
                                  },
                                  scrollbarVertical: {
                          ...
                          function setupResponsiveEventListener(
                            ...
                            var collected =
                              ...
                              events =
                                !collected && eventNames.split(_strSpace),
                              i = 0,
                          ...
                          function hostClassNamesChanged(
                            ...
                            if (
                              ...
                              for (
                                regex = createHostClassNameRegExp(!0, !0),
                                  i = 0;
                                i < diff.length;
                                i++
                              )
                            ...
                            if (
                              ...
                              var widthAuto =
                                ...
                                border = getTopRightBottomLeftHost(
                                  ...
                                  '-' + _strWidth,
                                  !(
                                    (widthAuto && _isBorderBox) ||
                                    !_isBorderBox
                                  ),
                                  !(
                                    (heightAuto && _isBorderBox) ||
                                    !_isBorderBox
                                  )
                                ),
                                margin =
                                ...
                                if (
                                  ...
                                  var textareaInfo =
                                    (function getTextareaInfo() {
                                      ...
                                      if (
                                        textareaCursorPosition !== undefined2
                                      ) {
                                        var rowCols,
                                          i,
                          ...
                          function setupStructureEvents() {
                            var textareaUpdateIntervalID,
                              ...
                              textareaKeyDownRestrictedKeyCodes = [
                                ...
                                121, 123, 33, 34, 37, 38, 39, 40, 16, 17, 18,
                                19, 20, 144,
                              ],
                          ...
                          function setTopRightBottomLeft(
                            ...
                            ;(values = values || [
                              ...
                              (targetCSSObject[prefix + _strBottom] =
                                values[2]),
                                ...
                                ? type(classesOrAttrs) == TYPES_s
                                  ...
                                  : (function () {
                                      var key,
                                        attrs = _strEmpty
                                      if (
                                        FRAMEWORK.isPlainObject(classesOrAttrs)
                                      )
                          ...
                          (_plugin = window2.OverlayScrollbars =
                            function (
                              ...
                              var inst,
                                ...
                                arr = [],
                                optsIsPlainObj =
                                  FRAMEWORK.isPlainObject(options)
                              return pluginTargetElements
                                ? ((pluginTargetElements =
                                    pluginTargetElements[LEXICON.l] !=
                                    undefined2
                                      ? pluginTargetElements
                                      : [
