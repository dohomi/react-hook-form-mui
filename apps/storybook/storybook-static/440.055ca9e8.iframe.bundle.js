      ...
      '../../node_modules/@storybook/components/dist/OverlayScrollbars-OL4C4TVX.mjs':
        (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          var m,
            ...
            is = (t2, n2) =>
              !!isElement(t2) &&
              (s.matches || s.msMatchesSelector).call(t2, n2),
            ...
            createOptionCheck = (t2, n2, o2) => (s2) =>
              [getPropByPath(t2, s2), o2 || void 0 !== getPropByPath(n2, s2)],
            createState = (t2) => {
              let n2 = t2
              return [
                () => n2,
              ...
              return (t3, n3, i3) => {
                ...
                if (
                  ...
                  let _3 = {
                    ...
                    h3 = {
                      w: Rt(
                        (p2 ? d2.innerWidth : f5.w + Rt(l3.w - e3.w)) + o3.w
                      ),
                      h: Rt(
            ...
            createStructureSetupObservers = (t2, n2, o2) => {
              let s2,
                ...
                onHostMutation = (t3, n3, o3) => {
                  let s3 = {Ot: n3}
                  return (
                    n3 ? !o3 && w3(s3) : d2 || updateViewportAttrsFromHost(t3),
                    s3
                  )
                },
                [p2, b3, m2] =
                    ...
                    ? ((t2, n2) => {
                        let o2,
                          ...
                          intersectionObserverCallback = (t3, n3) => {
                            if (t3 && t3.length > 0)
                              return triggerOnTrinsicChangedCallback(
                                t3.pop(),
                                n3
                              )
                          }
              ...
              return (
                ...
                [
                  ...
                  () => {
                    ...
                    return (
                      n3 &&
                        assignDeep(t3, onHostMutation.apply(0, push(n3, !0))),
                      o3 &&
                        assignDeep(t3, onTrinsicChanged.apply(0, push(o3, !0))),
                      s3 &&
                        assignDeep(
                          t3,
                          onContentMutation.apply(0, push(s3, !0))
                        ),
                      t3
                    )
                  },
              ...
              return (
                ...
                [
                  (t3, o3) => {
                    ...
                    return (
                      g2(s3), triggerUpdateEvent(f3(s3, v3(), o3), t3, !!o3)
                    )
                  },
                  w3,
                  () => {
                    ...
                    elements() {
                      ...
                      return assignDeep(
                        {},
                        {
                          ...
                          scrollbarVertical:
                            translateScrollbarsSetupElement(l3),
                        }
                      )
                    },
                    update: (t3) => update({}, t3),
          ...
          var O2 = () => {
            ...
            A2 = (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(
              (l2, c2) => {
                let {
                    element: t2 = 'div',
                    options: o2,
                  ...
                  [y2, d2] = ((l2) => {
                    let {options: c2, events: t2, defer: o2} = l2 || {},
                      [a2, i2] = (0,
                      react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(O2, []),
