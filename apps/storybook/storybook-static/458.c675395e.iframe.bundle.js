        ...
        function DateTimePickerElement(_ref) {
          ...
          return (
            required &&
              !validation.required &&
              (validation.required = 'This field is required'),
            (validation.validate = DateTimePickerElement_objectSpread(
              {
                internal: function internal(value) {
                  var _ref2,
                    _rest$timezone,
            ...
            (DateTimePickerElement.__docgenInfo = {
              ...
              props: {
                ...
                overwriteErrorMessages: {
                  ...
                  required: !1,
                  type: {
                    name: '{ invalidDate: string; disableFuture: string; disablePast: string; minutesStep: string; minTime: string; maxTime: string; "shouldDisableClock-hours": string; "shouldDisableClock-minutes": string; ... 8 more ...; maxDate: string; }',
                  },
                },
              },
            }),
        ...
        function TimePickerElement(_ref) {
          ...
          return (
            required &&
              !validation.required &&
              (validation.required = 'This field is required'),
            (validation.validate = TimePickerElement_objectSpread(
              {
                internal: function internal(value) {
                  var _ref2,
                    _rest$timezone,
            ...
            (TimePickerElement.__docgenInfo = {
              ...
              props: {
                ...
                overwriteErrorMessages: {
                  ...
                  required: !1,
                  type: {
                    name: '{ invalidDate: string; disableFuture: string; disablePast: string; minutesStep: string; minTime: string; maxTime: string; "shouldDisableClock-hours": string; "shouldDisableClock-minutes": string; "shouldDisableClock-seconds": string; "shouldDisableTime-hours": string; "shouldDisableTime-minutes": string; "shouldDisa...',
                  },
                },
              },
            }),
